...
-- ----------------------------
INSERT INTO `languages` VALUES (1, 'language', 'Language', 'ভাষা', 'لغة', 'La langue', 'भाषा', 'Bahasa', 'Lingua', '言語', '언어', 'Taal', 'Língua', 'ภาษา', 'Dil', 'زبان', '语言', 'Taal', 'Sprache', 'Γλώσσα', 'Idioma', 'भाषा', 'язык', 'Sprog', 'Լեզու', 'Ენა', 'इंग्रजी', 'Bahasa', 'ਭਾਸ਼ਾ', 'மொழி', 'భాషా', 'Språk', 'Wika');
INSERT INTO `languages` VALUES (2, 'attendance_overview', 'Attendance Overview', 'উপস্থিতি পরিদর্শন', 'نظرة عامة على الحضور', 'Aperçu de la fréquentation', 'उपस्थिति अवलोकन', 'Ikhtisar Kehadiran', 'Panoramica delle presenze', '出席の概要', '출석 개요', 'Aanwezigheid Overzicht', 'Visão geral de participação', 'ภาพรวมการเข้าร่วม', 'Seyirci Genel Bakış', 'حاضری جائزہ', '出勤概览', 'Bywoning Oorsig', 'Anwesenheitsübersicht', 'Επισκόπηση παρακολούθησης', 'Resumen de asistencia', 'उपस्थिति अवलोकन', 'Обзор посещаемости', 'Deltagelsesoversigt', 'Մասնակցության ակնարկ', 'დასწრების მიმოხილვა', 'उपस्थिती विहंगावलोकन', 'Tinjauan Kehadiran', 'ਹਾਜ਼ਰੀ ਬਾਰੇ ਸੰਖੇਪ ਜਾਣਕਾਰੀ', 'வருகை கண்ணோட்டம்', 'హాజరు అవలోకనం', 'Översikt över närvaro', 'Pangkalahatang Pangkalahatang-ideya');
...
INSERT INTO `languages` VALUES (108, 'present', 'Present', 'হাজির', 'حاضر', 'Présent', 'वर्तमान', 'Menyajikan', 'Presente', '現在', '선물', 'aanwezig', 'Presente', 'นำเสนอ', 'mevcut', 'پیش', '当下', 'teenwoordig', 'Vorhanden', 'Παρόν', 'Presente', 'प्रस्तुत', 'настоящее время', 'Til stede', 'Ներկայ', 'აწმყო', 'उपस्थित', 'Hadir', 'ਪੇਸ਼', 'தற்போது', 'ప్రస్తుతం', 'Närvarande', 'Kasalukuyan');
INSERT INTO `languages` VALUES (109, 'absent', 'Absent', 'অনুপস্থিত', 'غائب', 'Absent', 'अनुपस्थित', 'Tidak hadir', 'Assente', 'ありません', '없는', 'Afwezig', 'Ausente', 'ไม่อยู่', 'Yok', 'غائب', '缺席', 'afwesig', 'Abwesend', 'Απών', 'Ausente', 'अनुपस्थित', 'Отсутствует', 'Fraværende', 'Բացակա', 'Არდამსწრე', 'अनुपस्थित', 'Tidak hadir', 'ਗੈਰਹਾਜ਼ਰ', 'இல்லாதது', 'ఆబ్సెంట్', 'Frånvarande', 'Absent');
INSERT INTO `languages` VALUES (110, 'update_attendance', 'Update Attendance', 'আপডেট এ্যাটেনডেন্স', 'تحديث الحضور', 'Mise à jour de présence', 'अद्यतन उपस्थिति', 'Update Kehadiran', 'Aggiornamento presenze', '出席を更新', '업데이트 출석', 'Attendance bijwerken', 'Presença atualização', 'ปรับปรุงการเข้าร่วมประชุม', 'güncelleme Seyirci', 'اپ ڈیٹ حاضری', '更新考勤', 'Bywoning van bywerkings', 'Teilnahme aktualisieren', 'Ενημέρωση συμμετοχής', 'Actualización de asistencia', 'उपस्थिति अपडेट गर्नुहोस्', 'Обновление посещаемости', 'Opdater deltagelse', 'Թարմացրեք մասնակցությունը', 'დასწრება დასწრება', 'उपस्थिती अद्यतनित करा', 'Kemas kini Kehadiran', 'ਹਾਜ਼ਰੀ ਅਪਡੇਟ ਕਰੋ', 'வருகை புதுப்பிக்கவும்', 'హాజరును నవీకరించండి', 'Uppdatera närvaro', 'I-update ang Dumalo');
INSERT INTO `languages` VALUES (111, 'undefined', 'Undefined', 'অনির্দিষ্ট', 'غير محدد', 'Indéfini', 'अपरिभाषित', 'Tidak terdefinisi', 'Non definito', '未定義', '정의되지 않은', 'onbepaald', 'Indefinido', 'ไม่ได้กำหนด', 'tanımlanmamış', 'جانچ', '未定义', 'ongedefinieerde', 'Nicht definiert', 'Απροσδιόριστος', 'Indefinido', 'अपरिभाषित', 'Неопределенный', 'Udefineret', 'Չսահմանված', 'Განუსაზღვრელი', 'अपरिभाषित', 'Tidak ditentukan', 'ਪਰਿਭਾਸ਼ਤ', 'வரையறுக்கப்படவில்லை', 'వివరించలేని', 'Odefinierad', 'Hindi natukoy');
INSERT INTO `languages` VALUES (112, 'back', 'Back', 'পিছনে', 'الى الخلف', 'Arrière', 'वापस', 'Kembali', 'Indietro', 'バック', '뒤로', 'Terug', 'Costas', 'กลับ', 'Geri', 'واپس', '背部', 'terug', 'Zurück', 'Πίσω', 'atrás', 'पछाडि', 'назад', 'Tilbage', 'Ետ', 'უკან', 'मागे', 'Belakang', 'ਵਾਪਸ', 'மீண்டும்', 'తిరిగి', 'Tillbaka', 'Balik');
INSERT INTO `languages` VALUES (113, 'save_changes', 'Save Changes', 'পরিবর্তনগুলোর সংরক্ষন', 'حفظ التغيرات', 'Sauvegarder les modifications', 'परिवर्तनों को सुरक्षित करें', 'Simpan perubahan', 'Salva I Cambiamenti', '変更内容を保存', '변경 사항을 저장하다', 'Wijzigingen opslaan', 'Salvar alterações', 'บันทึกการเปลี่ยนแปลง', 'Değişiklikleri Kaydet', 'تبدیلیاں محفوظ کرو', '保存更改', 'Stoor veranderinge', 'Änderungen speichern', 'Αποθήκευσε τις αλλαγές', 'Guardar cambios', 'परिवर्तनहरू सुरक्षित गर्नुहोस', 'Сохранить изменения', 'Gem ændringer', 'Պահպանել փոփոխությունները', 'Ცვლილებების შენახვა', 'बदल जतन करा', 'Simpan Perubahan', 'ਕੀਤੇ ਗਏ ਬਦਲਾਅ ਸੁਰੱਖਿਅਤ ਕਰੋ', 'மாற்றங்களை சேமியுங்கள்', 'మార్పులను ఊంచు', 'Spara ändringar', 'I-save ang mga pagbabago');
INSERT INTO `languages` VALUES (114, 'uploader', 'Uploader', 'আপলোডার', 'رافع', 'Uploader', 'अपलोडर', 'pengunggah', 'Uploader', 'アップローダー', '업 로더', 'Uploader', 'Uploader', 'อัพโหลด', 'Yükleyici', 'اپ لوڈر', '上传', 'Uploader', 'Uploader', 'Μεταφορτωτής', 'Cargador', 'अपलोडर', 'загрузчик', 'Uploader', 'Վերբեռնող', 'ატვირთა', 'अपलोडर', 'Pemuat naik', 'ਅਪਲੋਡਰ', 'பதிவேற்றியவர்', 'అప్లోడర్', 'Uploader', 'Uploader');
INSERT INTO `languages` VALUES (115, 'download', 'Download', 'ডাউনলোড', 'تحميل', 'Télécharger', 'डाउनलोड', 'Download', 'Scaricare', 'ダウンロード', '다운로드', 'Download', 'baixar', 'ดาวน์โหลด', 'indir', 'لوڈ', '下载', 'Aflaai', 'Herunterladen', 'Κατεβάστε', 'Descargar', 'डाउनलोड गर्नुहोस्', 'Скачать', 'Hent', 'Ներբեռնեք', 'გადმოწერა', 'डाउनलोड करा', 'Muat turun', 'ਡਾ .ਨਲੋਡ', 'பதிவிறக்க Tamil', 'డౌన్లోడ్', 'Ladda ner', 'Pag-download');
INSERT INTO `languages` VALUES (116, 'remove', 'Remove', 'অপসারণ', 'إزالة', 'Retirer', 'हटाना', 'Menghapus', 'Cancella', '削除します', '없애다', 'Verwijderen', 'Remover', 'เอาออก', 'Kaldır', 'دور', '去掉', 'Verwyder', 'Entfernen', 'Αφαιρώ', 'Eliminar', 'हटाउनुहोस्', 'Удалить', 'Fjerne', 'Հեռացրեք', 'ამოიღეთ', 'काढा', 'Keluarkan', 'ਹਟਾਓ', 'அகற்று', 'తొలగించు', 'Avlägsna', 'Alisin');
INSERT INTO `languages` VALUES (117, 'print', 'Print', 'ছাপানো', 'طباعة', 'Impression', 'छाप', 'Mencetak', 'Stampare', '印刷', '인쇄', 'Afdrukken', 'Impressão', 'พิมพ์', 'baskı', 'پرنٹ', '打印', 'Print', 'Drucken', 'Τυπώνω', 'Impresión', 'प्रिन्ट गर्नुहोस्', 'Распечатать', 'Print', 'Տպել', 'დაბეჭდვა', 'प्रिंट', 'Cetak', 'ਛਾਪੋ', 'அச்சிடுக', 'ముద్రణ', 'Skriva ut', 'I-print');
INSERT INTO `languages` VALUES (118, 'select_file_type', 'Select File Type', 'নির্বাচন ফাইল টাইপ', 'حدد نوع الملف', 'Sélectionner le type de fichier', 'चुनें फ़ाइल प्रकार', 'Pilih File Type', 'Selezionare il tipo di file', 'ファイルタイプを選択します', '선택 파일 형식', 'Select File Type', 'Selecionar Tipo de Arquivo', 'เลือกประเภทไฟล์', 'Seçin Dosya Türü', 'منتخب فائل کی قسم', '选择文件类型', 'Kies lêertipe', 'Wählen Sie Dateityp', 'Επιλέξτε Τύπος αρχείου', 'Seleccionar tipo de archivo', 'फाइल प्रकार चयन गर्नुहोस्', 'Выберите тип файла', 'Vælg Filtype', 'Ընտրեք ֆայլի տեսակը', 'აირჩიეთ ფაილის ტიპი', 'फाइल प्रकार निवडा', 'Pilih Jenis Fail', 'ਫਾਈਲ ਕਿਸਮ ਚੁਣੋ', 'கோப்பு வகையைத் தேர்ந்தெடுக்கவும்', 'ఫైల్ రకాన్ని ఎంచుకోండి', 'Välj filtyp', 'Piliin ang Uri ng File');
INSERT INTO `languages` VALUES (119, 'excel', 'Excel', 'সীমা অতিক্রম করা', 'تفوق', 'Exceller', 'एक्सेल', 'Unggul', 'Eccellere', 'エクセル', '뛰어나다', 'uitmunten', 'sobressair', 'Excel', 'Excel', 'ایکسل', '高强', 'Excel', 'Excel', 'Υπερτερώ', 'Excel', 'एक्सेल', 'превосходить', 'Excel', 'Excel- ը', 'Excel', 'एक्सेल', 'Excel', 'ਐਕਸਲ', 'எக்செல்', 'Excel', 'Excel', 'Excel');
INSERT INTO `languages` VALUES (120, 'other', 'Other', 'অন্যান্য', 'آخر', 'Autre', 'अन्य', 'Lain', 'Altro', '他の', '다른', 'anders', 'De outros', 'อื่น ๆ', 'Diğer', 'دیگر', '其他', 'ander', 'Andere', 'Αλλα', 'Otro', 'अन्य', 'Другой', 'Andet', 'Այլ', 'სხვა', 'इतर', 'Yang lain', 'ਹੋਰ', 'மற்றவை', 'ఇతర', 'Övrig', 'Iba pa');
...
INSERT INTO `languages` VALUES (126, 'session_changed', 'Session Changed', 'সেশন পরিবর্তিত', 'جلسة تغيير', 'session Changed', 'सत्र बदली गई', 'sesi Berubah', 'sessione cambiato', 'セッションが変更します', '세션 변경', 'Session Changed', 'sessão Changed', 'เซสชั่นเปลี่ยน', 'Oturum Değişti', 'سیشن تبدیل کر دیا گیا', '会议改', 'Sessie verander', 'Sitzung geändert', 'Η περίοδος σύνδεσης άλλαξε', 'Sesión cambiada', 'सत्र परिवर्तन गरियो', 'Сессия изменена', 'Session ændret', 'Նիստը փոխվեց', 'სხდომა შეიცვალა', 'सत्र बदलले', 'Sesi Berubah', 'ਸੈਸ਼ਨ ਬਦਲਿਆ', 'அமர்வு மாற்றப்பட்டது', 'సెషన్ మార్చబడింది', 'Sessionen har ändrats', 'Nabago ang Session');
INSERT INTO `languages` VALUES (127, 'exam_marks', 'Exam Marks', 'পরীক্ষার মার্কস', 'علامات الامتحان', 'Marques d\'examen', 'परीक्षा मार्क्स', 'Marks ujian', 'Marks esame', '試験マークス', '시험 마크', 'examen Marks', 'Marcas de exame', 'Marks สอบ', 'sınav Marks', 'امتحان مارکس', '考试马克斯', 'Eksamenmerke', 'Prüfungsnoten', 'Σήματα εξετάσεων', 'Marcas de examen', 'परीक्षा मार्कहरू', 'Экзаменационные Знаки', 'Eksamen Marks', 'Քննության նշաններ', 'საგამოცდო ნიშნები', 'परीक्षा गुण', 'Markah Peperiksaan', 'ਪ੍ਰੀਖਿਆ ਦੇ ਅੰਕ', 'தேர்வு மதிப்பெண்கள்', 'పరీక్షా మార్కులు', 'Examensmärken', 'Exam Marks');
INSERT INTO `languages` VALUES (128, 'total_mark', 'Total Mark', 'মোট মার্ক', 'عدد الأقسام', 'total Mark', 'कुल मार्क', 'total Mark', 'Mark totale', '合計マーク', '총 마크', 'Totaal Mark', 'total de Mark', 'มาร์ครวม', 'Toplam Mark', 'کل مارک', '积分', 'Totale punt', 'Gesamtnote', 'Συνολικό σήμα', 'Marca total', 'कुल मार्क', 'Общая оценка', 'Samlet mærke', 'Ընդհանուր նշան', 'სულ მარკა', 'एकूण चिन्ह', 'Jumlah Markah', 'ਕੁੱਲ ਮਾਰਕ', 'மொத்த குறி', 'మొత్తం మార్క్', 'Totalt antal', 'Kabuuang Markahan');
INSERT INTO `languages` VALUES (129, 'mark_obtained', 'Mark Obtained', 'মার্ক প্রাপ্ত', 'علامة حصل', 'Mark Obtenu', 'चिह्न प्राप्त', 'Mark Diperoleh', 'Mark Ottenuto', 'マーク取得', '마크 획득', 'Mark verkregen', 'Mark Obtido', 'มาร์คได้รับ', 'Mark elde', 'مارک حاصل', '标记所获得', 'Mark verwerf', 'Mark erhalten', 'Ο Μαρκ αποκτήθηκε', 'Marca obtenida', 'मार्क प्राप्त भयो', 'Получено', 'Mark opnået', 'Մարկը ձեռք է բերել', 'მარკი მიიღო', 'मार्क प्राप्त', 'Markah Diperolehi', 'ਮਾਰਕ ਪ੍ਰਾਪਤ ਕੀਤਾ', 'மார்க் பெறப்பட்டது', 'మార్క్ పొందబడింది', 'Mark erhölls', 'Nakuha si Mark');
INSERT INTO `languages` VALUES (130, 'invoice/payment_list', 'Invoice / Payment List', 'ইনভয়েস / পেমেন্ট তালিকা', 'فاتورة / قائمة دفع', 'Facture / Liste de paiement', 'चालान / भुगतान सूची', 'Faktur / Daftar pembayaran', 'Fattura / Lista pagamento', '請求書/支払一覧', '송장 / 지불 목록', 'Factuur / betaling List', 'Invoice / Lista de pagamento', 'ใบแจ้งหนี้ / รายการชำระเงิน', 'Fatura / ödeme listesi', 'انوائس / ادائیگی کی فہرست', '发票/付款清单', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (131, 'obtained_marks', 'Obtained Marks', 'প্রাপ্ত মার্কস', 'العلامات التي تم الحصول عليها', 'Les notes obtenues', 'प्राप्त अंकों', 'Marks diperoleh', 'punteggi ottenuti', '得られマークス', '획득 마크', 'verkregen Marks', 'notas obtidas', 'เครื่องหมายที่ได้รับ', 'elde edilen Marks', 'حاصل مارکس', '获得商标', 'Punte verwerf', 'Erhaltene Noten', 'Λήφθηκαν σήματα', 'Marcas obtenidas', 'प्राप्त अंक', 'Полученные знаки', 'Opnået Marks', 'Ձեռք բերեց նշաններ', 'მიღებული ნიშნები', 'गुण प्राप्त केले', 'Tanda Mendapat', 'ਅੰਕ ਪ੍ਰਾਪਤ ਕੀਤੇ', 'பெறப்பட்ட மதிப்பெண்கள்', 'పొందిన మార్కులు', 'Erhölls märken', 'Nakuha Marks');
INSERT INTO `languages` VALUES (132, 'highest_mark', 'Highest Mark', 'সর্বোচ্চ মার্ক', 'أعلى الأقسام', 'le plus élevé Mark', 'उच्चतम निशान', 'Mark tertinggi', 'Massima Mark', '最高点', '최고 마크', 'hoogste Mark', 'maior Mark', 'มาร์คสูงสุด', 'En yüksek işaretle', 'سب سے زیادہ نشان', '最高分', 'Hoogste punt', 'Höchste Note', 'Υψηλότερη βαθμολογία', 'Marca más alta', 'उच्चतम मार्क', 'Высшая оценка', 'Højeste mark', 'Ամենաբարձր Մարկը', 'ყველაზე მაღალი მარკა', 'सर्वोच्च चिन्ह', 'Tanda Tertinggi', 'ਉੱਚ ਮਾਰਕ', 'உயர்ந்த குறி', 'అత్యధిక మార్క్', 'Högsta märket', 'Pinakamataas na Markahan');
INSERT INTO `languages` VALUES (133, 'grade', 'Grade (GPA)', 'শ্রেণী', 'درجة', 'Qualité', 'ग्रेड', 'Kelas', 'Grado', 'グレード', '학년', 'Rang', 'Grau', 'เกรด', 'sınıf', 'گریڈ', '年级', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (134, 'dashboard', 'Dashboard', 'ড্যাশবোর্ড', 'لوحة القيادة', 'Tableau de bord', 'डैशबोर्ड', 'Dasbor', 'Cruscotto', 'ダッシュボード', '계기반', 'Dashboard', 'painel de instrumentos', 'แผงควบคุม', 'gösterge paneli', 'ڈیش بورڈ', '仪表板', 'Dashboard', 'Instrumententafel', 'Ταμπλό', 'Tablero', 'ड्यासबोर्ड', 'Приборная панель', 'instrumentbræt', 'Գրասեղան', 'დაფა', 'डॅशबोर्ड', 'Papan Pemuka', 'ਡੈਸ਼ਬੋਰਡ', 'டாஷ்போர்டு', 'డాష్బోర్డ్', 'instrumentbräda', 'Dashboard');
INSERT INTO `languages` VALUES (135, 'student', 'Student', 'ছাত্র', 'طالب علم', 'Élève', 'छात्र', 'Mahasiswa', 'Alunno', '学生', '학생', 'Student', 'Aluna', 'นักเรียน', 'öğrenci', 'طالب علم', '学生', 'student', 'Schüler', 'Μαθητης σχολειου', 'Estudiante', 'विद्यार्थी', 'Студент', 'Studerende', 'Ուսանող', 'Სტუდენტი', 'विद्यार्थी', 'Pelajar', 'ਵਿਦਿਆਰਥੀ', 'மாணவர்', 'విద్యార్థి', 'Studerande', 'Mag-aaral');
INSERT INTO `languages` VALUES (136, 'rename', 'Rename', 'নামান্তর', 'إعادة تسمية', 'rebaptiser', 'नाम बदलने', 'ganti nama', 'rinominare', '名前を変更する', '이름 바꾸기', 'andere naam geven', 'renomear', 'ตั้งชื่อใหม่', 'adını değiştirmek', 'تبدیل کریں', '改名', 'Naam verander', 'Umbenennen', 'Μετονομάζω', 'Rebautizar', 'नाम बदल्नुहोस्', 'Rename', 'Omdøb', 'Անվանափոխել', 'გადარქმევა', 'नाव बदला', 'Namakan semula', 'ਨਾਮ ਬਦਲੋ', 'மறுபெயரிடு', 'పేరు మార్చు', 'Döp om', 'Palitan ang pangalan');
INSERT INTO `languages` VALUES (137, 'class', 'Class', 'শ্রেণী', 'صف مدرسي', 'Classe', 'कक्षा', 'Kelas', 'Classe', 'クラス', '수업', 'Klasse', 'Classe', 'ชั้น', 'sınıf', 'کلاس', '类', 'klas', 'Klasse', 'Τάξη', 'Clase', 'कक्षा', 'Учебный класс', 'klasse', 'Դաս', 'Კლასი', 'वर्ग', 'Kelas', 'ਕਲਾਸ', 'வர்க்கம்', 'క్లాస్', 'Klass', 'Klase');
INSERT INTO `languages` VALUES (138, 'teacher', 'Teacher', 'শিক্ষক', 'مدرس', 'Professeur', 'अध्यापक', 'Guru', 'Insegnante', '先生', '선생', 'Leraar', 'Professor', 'ครู', 'öğretmen', 'ٹیچر', '老师', 'onderwyser', 'Lehrer', 'Δάσκαλος', 'Profesor', 'शिक्षक', 'учитель', 'Lærer', 'Ուսուցիչ', 'მასწავლებელს', 'शिक्षक', 'Cikgu', 'ਅਧਿਆਪਕ', 'ஆசிரியர்', 'టీచర్', 'Lärare', 'Guro');
INSERT INTO `languages` VALUES (139, 'parents', 'Parents', 'মাতাপিতা', 'الآباء', 'Des parents', 'माता-पिता', 'Orangtua', 'genitori', '親', '부모님', 'Ouders', 'Pais', 'พ่อแม่', 'ebeveyn', 'والدین', '父母', 'Ouers', 'Eltern', 'Γονείς', 'Padres', 'अभिभावक', 'Родители', 'Forældre', 'Ծնողներ', 'მშობლები', 'पालक', 'Ibu bapa', 'ਮਾਪੇ', 'பெற்றோர்', 'తల్లిదండ్రులు', 'Föräldrar', 'Mga magulang');
INSERT INTO `languages` VALUES (140, 'subject', 'Subject', 'বিষয়', 'موضوع', 'Assujettir', 'विषय', 'Subyek', 'Soggetto', 'テーマ', '제목', 'Onderwerpen', 'Sujeito', 'เรื่อง', 'konu', 'موضوع', '学科', 'Onderwerp', 'Gegenstand', 'Θέμα', 'Tema', 'बिषय', 'Тема', 'Emne', 'Առարկա', 'საგანი', 'विषय', 'Subjek', 'ਵਿਸ਼ਾ', 'பொருள்', 'Subject', 'Ämne', 'Paksa');
INSERT INTO `languages` VALUES (141, 'student_attendance', 'Student Attendance', 'ছাত্র উপস্থিতি', 'حضور الطالب', 'Participation des étudiants', 'छात्र उपस्थिति', 'Kehadiran siswa', 'Frequenza degli studenti', '学生の出席', '학생 출석', 'Studentenbijwonen', 'Freqüência de estudantes', 'การเข้าเรียนของนักเรียน', 'Öğrenci yurdu', 'طلبا کی حاضری', '出席学生', 'Studente-bywoning', 'Teilnahme von Studenten', 'Φοιτητική φοίτηση', 'Asistencia estudiantil', 'विद्यार्थी उपस्थिति', 'Посещаемость студентов', 'Studerendes deltagelse', 'Ուսանողների հաճախում', 'სტუდენტური დასწრება', 'विद्यार्थ्यांची उपस्थिती', 'Kehadiran Pelajar', 'ਵਿਦਿਆਰਥੀਆਂ ਦੀ ਹਾਜ਼ਰੀ', 'மாணவர் வருகை', 'విద్యార్థుల హాజరు', 'Studentdeltagande', 'Pag-aaral ng Mag-aaral');
INSERT INTO `languages` VALUES (142, 'exam_list', 'Exam List', 'পরীক্ষার তালিকা', 'قائمة الامتحان', 'Liste d\'examen', 'परीक्षा सूची', 'Daftar ujian', 'Lista esame', '試験のリスト', '시험 목록', 'examen Lijst', 'Lista de exame', 'รายการสอบ', 'sınav listesi', 'امتحان کی فہرست', '考试名单', 'Eksamenlys', 'Prüfungsliste', 'Λίστα εξετάσεων', 'Lista de examen', 'परीक्षा सूची', 'Список экзаменов', 'Eksamen liste', 'Քննությունների ցուցակ', 'გამოცდების სია', 'परीक्षा यादी', 'Senarai Peperiksaan', 'ਪ੍ਰੀਖਿਆ ਸੂਚੀ', 'தேர்வு பட்டியல்', 'పరీక్షా జాబితా', 'Examellista', 'Listahan ng Exam');
INSERT INTO `languages` VALUES (143, 'grades_range', 'Grades Range', 'গ্রেড পরিসীমা', 'مجموعة الدرجات', 'Gamme de notes', 'ग्रेड श्रेणी', 'Kisaran nilai', 'Gamma di gradi', 'グレードの範囲', '성적 범위', 'Rangen bereik', 'Escala de notas', 'ช่วงคะแนน', 'Derece aralığı', 'گریڈ کی حد', '等级范围', 'Graadreeks', 'Notenbereich', 'Εύρος βαθμών', 'Rango de Grados', 'ग्रेड्स दायरा', 'Диапазон оценок', 'Karakterinterval', 'Դասարանների միջակայք', 'კლასების დიაპაზონი', 'ग्रेड श्रेणी', 'Julat Gred', 'ਗ੍ਰੇਡ ਰੇਂਜ', 'தர வரம்பு', 'తరగతుల పరిధి', 'Betygsnivå', 'Saklaw ng Grades');
INSERT INTO `languages` VALUES (144, 'loading', 'Loading', 'বোঝাই', 'جار التحميل', 'chargement', 'लोड हो रहा है', 'pemuatan', 'Caricamento in corso', 'ローディング', '로딩', 'bezig met laden', 'Carregando', 'โหลด', 'Yükleniyor', 'لوڈنگ', '装载', 'laai', 'Wird geladen', 'Φόρτωση', 'Cargando', 'लोड हुँदै', 'загрузка', 'Indlæser', 'Բեռնվում է', 'Ჩატვირთვა', 'लोड करीत आहे', 'Memuatkan', 'ਲੋਡ ਹੋ ਰਿਹਾ ਹੈ', 'ஏற்றுகிறது', 'లోడ్', 'Läser in', 'Naglo-load');
INSERT INTO `languages` VALUES (145, 'library', 'Library', 'লাইব্রেরি', 'مكتبة', 'Bibliothèque', 'पुस्तकालय', 'Perpustakaan', 'Biblioteca', 'ライブラリ', '도서관', 'Bibliotheek', 'Biblioteca', 'ห้องสมุด', 'kütüphane', 'لائبریری', '图书馆', 'biblioteek', 'Bibliothek', 'Βιβλιοθήκη', 'Biblioteca', 'पुस्तकालय', 'Библиотека', 'Bibliotek', 'Գրադարան', 'ბიბლიოთეკა', 'ग्रंथालय', 'Perpustakaan', 'ਲਾਇਬ੍ਰੇਰੀ', 'நூலகம்', 'గ్రంధాలయం', 'Bibliotek', 'Library');
INSERT INTO `languages` VALUES (146, 'hostel', 'Hostel', 'ছাত্রাবাস', 'المهجع', 'Dortoir', 'छात्रावास', 'asrama mahasiswa', 'Dormitorio', '寮', '기숙사', 'Slaapzaal', 'Dormitório', 'หอพัก', 'Yurt', 'شیناگار', '宿舍', 'Koshuis', 'Hostel', 'Ξενοδοχείο', 'Hostal', 'छात्रावास', 'Общежитие', 'Vandrerhjem', 'Հոսթել', 'Ჰოსტელი', 'वसतिगृहात', 'Asrama', 'ਹੋਸਟਲ', 'தங்கும் விடுதி', 'వసతిగృహం', 'Vandrarhem', 'Hostel');
INSERT INTO `languages` VALUES (147, 'events', 'Events', 'সূচনাফলক', 'اللافتة', 'Tableau d\'affichage', 'सूचना पट्ट', 'Papan peringatan', 'Bacheca', '掲示板', '공지 사항 게시판', 'Notitiebord', 'Quadro de notícias', 'กระดานป้ายติดประกาศ', 'noticeboard', 'نوٹس بورڈ', '布告栏', 'gebeure', 'Veranstaltungen', 'Εκδηλώσεις', 'Eventos', 'घटनाहरू', 'Мероприятия', 'Begivenheder', 'Իրադարձություններ', 'Ივენთი', 'कार्यक्रम', 'Acara', 'ਸਮਾਗਮ', 'நிகழ்வுகள்', 'ఈవెంట్స్', 'evenemang', 'Mga Kaganapan');
INSERT INTO `languages` VALUES (148, 'message', 'Message', 'বার্তা', 'الرسالة', 'Message', 'संदेश', 'Pesan', 'Messaggio', 'メッセージ', '메시지', 'Bericht', 'Mensagem', 'ข่าวสาร', 'Mesaj', 'پیغام', '信息', 'boodskap', 'Botschaft', 'Μήνυμα', 'Mensaje', 'सन्देश', 'Сообщение', 'Besked', 'Հաղորդագրություն', 'მესიჯი', 'संदेश', 'Mesej', 'ਸੁਨੇਹਾ', 'செய்தி', 'సందేశం', 'Meddelande', 'Mensahe');
INSERT INTO `languages` VALUES (149, 'translations', 'Translations', 'অনুবাদের', 'ترجمة', 'traductions', 'अनुवाद', 'terjemahan', 'traduzioni', '翻訳', '번역', 'vertaalwerk', 'traduções', 'แปล', 'çeviriler', 'ترجمہ', '译文', 'vertalings', 'Übersetzungen', 'Μεταφράσεις', 'Traducciones', 'अनुवाद', 'Переводы', 'Oversættelser', 'Թարգմանություններ', 'თარგმანები', 'भाषांतर', 'Terjemahan', 'ਅਨੁਵਾਦ', 'மொழிபெயர்ப்புகள்', 'అనువాదాలు', 'översättningar', 'Pagsasalin');
INSERT INTO `languages` VALUES (150, 'account', 'Account', 'হিসাব', 'حساب', 'Compte', 'लेखा', 'Rekening', 'account', 'アカウント', '계정', 'Account', 'Conta', 'บัญชี', 'hesap', 'اکاؤنٹ', '帐户', 'rekening', 'Konto', 'λογαριασμός', 'Cuenta', 'खाता', 'Счет', 'Konto', 'Հաշիվ', 'ანგარიში', 'खाते', 'Akaun', 'ਖਾਤਾ', 'கணக்கு', 'ఖాతా', 'konto', 'Account');
INSERT INTO `languages` VALUES (151, 'selected_session', 'Selected Session', 'নির্বাচিত সেশন', 'جلسة مختارة', 'session sélectionnée', 'चयनित सत्र', 'sesi terpilih', 'sessione selezionata', '選択されたセッション', '선택된 세션', 'geselecteerde sessie', 'sessão selecionada', 'เซสชันที่เลือก', 'seçilen oturum', 'منتخب کردہ سیشن', '选定的会话', 'Geselekteerde sessie', 'Ausgewählte Sitzung', 'Επιλεγμένη περίοδος σύνδεσης', 'Sesión Seleccionada', 'चयनित सत्र', 'Выбранная сессия', 'Valgt session', 'Ընտրված նիստ', 'არჩეული სესია', 'निवडलेले सत्र', 'Sesi Terpilih', 'ਚੁਣਿਆ ਸੈਸ਼ਨ', 'தேர்ந்தெடுக்கப்பட்ட அமர்வு', 'ఎంచుకున్న సెషన్', 'Vald session', 'Napiling Session');
INSERT INTO `languages` VALUES (152, 'change_password', 'Change Password', 'পাসওয়ার্ড পরিবর্তন করুন', 'تغيير كلمة السر', 'Changer le mot de passe', 'पासवर्ड बदलें', 'Ganti kata sandi', 'Cambia la password', 'パスワードを変更する', '암호 변경', 'Verander wachtwoord', 'Mudar senha', 'เปลี่ยนรหัสผ่าน', 'Şifre değiştir', 'پاس ورڈ تبدیل کریں', '更改密码', 'Geselekteerde sessie', 'Ausgewählte Sitzung', 'Επιλεγμένη περίοδος σύνδεσης', 'Sesión Seleccionada', 'चयनित सत्र', 'Выбранная сессия', 'Valgt session', 'Ընտրված նիստ', 'არჩეული სესია', 'निवडलेले सत्र', 'Sesi Terpilih', 'ਚੁਣਿਆ ਸੈਸ਼ਨ', 'தேர்ந்தெடுக்கப்பட்ட அமர்வு', 'ఎంచుకున్న సెషన్', 'Vald session', 'Napiling Session');
INSERT INTO `languages` VALUES (153, 'section', 'Section', 'অধ্যায়', 'قسم', 'Section', 'अनुभाग', 'Bagian', 'Sezione', 'セクション', '섹션', 'sectie', 'Seção', 'มาตรา', 'Bölüm', 'سیکشن', '部分', 'artikel', 'Sektion', 'Ενότητα', 'Sección', 'खण्ड', 'Раздел', 'Afsnit', 'Բաժին', 'განყოფილება', 'विभाग', 'Bahagian', 'ਅਨੁਭਾਗ', 'பிரிவு', 'విభాగం', 'Sektion', 'Seksyon');
INSERT INTO `languages` VALUES (154, 'edit', 'Edit', 'সম্পাদন করা', 'تحرير', 'modifier', 'संपादित करें', 'mengedit', 'Modifica', '編集', '편집하다', 'Bewerk', 'Editar', 'แก้ไข', 'Düzenleme', 'تصیح', '编辑', 'wysig', 'Bearbeiten', 'Επεξεργασία', 'Editar', 'सम्पादन गर्नुहोस्', 'редактировать', 'Redigere', 'Խմբագրել', 'რედაქტირება', 'सुधारणे', 'Edit', 'ਸੰਪਾਦਿਤ ਕਰੋ', 'தொகு', 'మార్చు', 'Redigera', 'I-edit');
INSERT INTO `languages` VALUES (155, 'delete', 'Delete', 'মুছে ফেলা', 'حذف', 'Effacer', 'मिटाना', 'Menghapus', 'cancellare', '削除', '지우다', 'Verwijder', 'Excluir', 'ลบ', 'silmek', 'حذف کریں', '删除', 'Delete', 'Löschen', 'Διαγράφω', 'Eliminar', 'मेटाउन', 'удалять', 'Slet', 'Նջել', 'წაშლა', 'हटवा', 'Padam', 'ਮਿਟਾਓ', 'அழி', 'తొలగించు', 'Radera', 'Tanggalin');
INSERT INTO `languages` VALUES (156, 'cancel', 'Cancel', 'বাতিল', 'إلغاء', 'Annuler', 'रद्द करना', 'Membatalkan', 'Annulla', 'キャンセル', '취소', 'Annuleer', 'Cancelar', 'ยกเลิก', 'İptal', 'منسوخ کریں', '取消', 'kanselleer', 'Stornieren', 'Ματαίωση', 'Cancelar', 'रद्द गर्नुहोस्', 'Отмена', 'Afbestille', 'Չեղարկել', 'გაუქმება', 'रद्द करा', 'Batal', 'ਰੱਦ ਕਰੋ', 'ரத்துசெய்', 'రద్దు చేయండి', 'Avbryt', 'Pagkansela');
INSERT INTO `languages` VALUES (157, 'parent', 'Parent', 'মাতা', 'أصل', 'Parent', 'माता-पिता', 'Induk', 'Genitore', '親', '부모의', 'Ouder', 'parente', 'ผู้ปกครอง', 'ebeveyn', 'والدین', '亲', 'ouer', 'Elternteil', 'Μητρική εταιρεία', 'Padre', 'अभिभावक', 'родитель', 'Forældre', 'Ծնող', 'მშობელი', 'पालक', 'Ibu bapa', 'ਮਾਪੇ', 'பெற்றோர்', 'మాతృ', 'Förälder', 'Magulang');
INSERT INTO `languages` VALUES (158, 'attendance', 'Attendance', 'উপস্থিতি', 'الحضور', 'Présence', 'उपस्थिति', 'Kehadiran', 'partecipazione', '出席', '출석', 'opkomst', 'Comparecimento', 'การดูแลรักษา', 'katılım', 'حاضری', '护理', 'Bywoning', 'Teilnahme', 'Παρουσία', 'Asistencia', 'उपस्थित', 'посещаемость', 'Tilstedeværelse', 'Հաճախում', 'დასწრება', 'उपस्थिती', 'Kehadiran', 'ਹਾਜ਼ਰੀ', 'வருகை', 'హాజరు', 'Närvaro', 'Pagdalo');
INSERT INTO `languages` VALUES (159, 'addmission_form', 'Admission Form', 'ভর্তির ফর্ম', 'شكل القبول', 'Formulaire d\'admission', 'प्रवेश फार्म', 'Formulir Pendaftaran', 'Modulo di ammissione', '入学式', '입학 허가서', 'Toelatingsformulier', 'Formulário de admissão', 'แบบฟอร์มการรับสมัคร', 'Kabul Formu', 'داخلہ فارم', '入学表格', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (160, 'name', 'Name', 'নাম', 'اسم', 'prénom', 'नाम', 'Nama', 'Nome', '名', '이름', 'Naam', 'Nome', 'ชื่อ', 'isim', 'نام', '名称', 'naam', 'Name', 'Ονομα', 'Nombre', 'नाम', 'имя', 'Navn', 'Անուն', 'სახელი', 'नाव', 'Nama', 'ਨਾਮ', 'பெயர்', 'పేరు', 'namn', 'Pangalan');
INSERT INTO `languages` VALUES (161, 'select', 'Select', 'নির্বাচন করা', 'اختار', 'Sélectionner', 'चुनते हैं', 'Memilih', 'Selezionare', '選択します', '고르다', 'kiezen', 'selecionar', 'เลือก', 'seçmek', 'منتخب کریں', '选择', 'Kies', 'Wählen', 'Επιλέγω', 'Seleccione', 'चयन गर्नुहोस्', 'Выбрать', 'Vælg', 'Ընտրեք', 'შეარჩიეთ', 'निवडा', 'Pilih', 'ਚੁਣੋ', 'தேர்ந்தெடு', 'ఎంచుకోండి', 'Välj', 'Piliin');
INSERT INTO `languages` VALUES (162, 'roll', 'Roll', 'রোল', 'لفة', 'Roulent', 'रोल', 'Gulungan', 'Rotolo', 'ロール', '롤', 'Rollen', 'Rolo', 'ม้วน', 'Rulo', 'رول', '滚', 'roll', 'Rollen', 'Ρολό', 'Rodar', 'रोल', 'Рулон', 'Rulle', 'Գլորել', 'გააფართოვოს', 'रोल', 'Gulung', 'ਰੋਲ', 'ரோல்', 'రోల్', 'Roll', 'Gumulong');
INSERT INTO `languages` VALUES (163, 'birthday', 'Date Of Birth', 'জন্ম তারিখ', 'تاريخ الميلاد', 'Anniversaire', 'जन्मदिन', 'Ulang tahun', 'Compleanno', 'お誕生日', '생일', 'Verjaardag', 'Aniversário', 'วันเกิด', 'Doğum günü', 'سالگرہ', '生日', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (164, 'gender', 'Gender', 'লিঙ্গ', 'جنس', 'Le genre', 'लिंग', 'Jenis kelamin', 'Genere', '性別', '성별', 'Geslacht', 'Gênero', 'เพศ', 'Cinsiyet', 'صنف', '性别', 'geslag', 'Geschlecht', 'Γένος', 'Género', 'लि .्ग', 'Пол', 'Køn', 'Գենդեր', 'გენდერი', 'लिंग', 'Jantina', 'ਲਿੰਗ', 'பாலினம்', 'జెండర్', 'Kön', 'Kasarian');
INSERT INTO `languages` VALUES (165, 'male', 'Male', 'পুরুষ', 'ذكر', 'Mâle', 'नर', 'Pria', 'Maschio', '男性', '남성', 'Mannetje', 'Masculino', 'ชาย', 'Erkek', 'مرد', '男', 'Manlik', 'Männlich', 'Αρσενικός', 'Masculino', 'नर', 'мужчина', 'Han', 'Արական', 'მამაკაცი', 'नर', 'Lelaki', 'ਮਰਦ', 'ஆண்', 'పురుషుడు', 'Manlig', 'Lalaki');
INSERT INTO `languages` VALUES (166, 'female', 'Female', 'মহিলা', 'أنثى', 'Femelle', 'महिला', 'Wanita', 'Femmina', '女性', '여자', 'Vrouw', 'Fêmea', 'หญิง', 'Kadın', 'خواتین', '女', 'vroulike', 'Weiblich', 'Θηλυκός', 'Hembra', 'महिला', 'женский', 'Kvinde', 'իգական', 'ქალი', 'स्त्री', 'Perempuan', 'Femaleਰਤ', 'பெண்', 'స్త్రీ', 'Kvinna', 'Babae');
INSERT INTO `languages` VALUES (167, 'address', 'Address', 'ঠিকানা', 'عنوان', 'Adresse', 'पता', 'Alamat', 'Indirizzo', '住所', '주소', 'Adres', 'Endereço', 'ที่อยู่', 'adres', 'ایڈریس', '地址', 'adres', 'Adresse', 'Διεύθυνση', 'Habla a', 'ठेगाना', 'Адрес', 'Adresse', 'Հասցե', 'მისამართი', 'पत्ता', 'Alamat', 'ਪਤਾ', 'முகவரி', 'చిరునామా', 'Adress', 'Address');
INSERT INTO `languages` VALUES (168, 'phone', 'Phone', 'ফোন', 'هاتف', 'Téléphone', 'फ़ोन', 'Telepon', 'Telefono', '電話', '전화', 'Telefoon', 'Telefone', 'โทรศัพท์', 'Telefon', 'فون', '电话', 'Foon', 'Telefon', 'Τηλέφωνο', 'Teléfono', 'फोन', 'Телефон', 'telefon', 'Հեռախոս', 'ტელეფონი', 'फोन', 'Telefon', 'ਫੋਨ', 'தொலைபேசி', 'ఫోన్', 'Telefon', 'Telepono');
INSERT INTO `languages` VALUES (169, 'email', 'Email', 'ই-মেইল', 'البريد الإلكتروني', 'Email', 'ईमेल', 'E-mail', 'E-mail', 'Eメール', '이메일', 'E-mail', 'O email', 'อีเมล์', 'E-posta', 'دوستوں کوارسال کریں', '电子邮件', 'e-pos', 'Email', 'ΗΛΕΚΤΡΟΝΙΚΗ ΔΙΕΥΘΥΝΣΗ', 'Correo electrónico', 'ईमेल', 'Электронное письмо', 'E-mail', 'Էլ', 'ელ.ფოსტა', 'ईमेल', 'E-mel', 'ਈ - ਮੇਲ', 'மின்னஞ்சல்', 'ఇమెయిల్', 'E-post', 'Email');
INSERT INTO `languages` VALUES (170, 'password', 'Password', 'পাসওয়ার্ড', 'كلمه السر', 'Mot de passe', 'पासवर्ड', 'Kata sandi', 'parola d\'ordine', 'パスワード', '암호', 'Wachtwoord', 'Senha', 'รหัสผ่าน', 'Parola', 'پاس ورڈ', '密码', 'wagwoord', 'Passwort', 'Κωδικός πρόσβασης', 'Contraseña', 'पासवर्ड', 'пароль', 'Adgangskode', 'Գաղտնաբառ', 'პაროლი', 'संकेतशब्द', 'Kata Laluan', 'ਪਾਸਵਰਡ', 'கடவுச்சொல்', 'పాస్వర్డ్', 'Lösenord', 'Password');
INSERT INTO `languages` VALUES (171, 'transport_route', 'Transport Route', 'পরিবহন রুট', 'النقل الطريق', 'Transport Route', 'परिवहन मार्ग', 'Transportasi Route', 'Transport Route', '交通ルート', '운송 경로', 'transport Route', 'Itinerários', 'เส้นทางขนส่ง', 'Ulaştırma Rota', 'ٹرانسپورٹ روٹ', '运输路线', 'Padvervoer', 'Straßentransport', 'Οδικές μεταφορές', 'Transporte por carretera', 'सडक यातायात', 'Транспортный маршрут', 'Vejtransport', 'Ճանապարհային տրանսպորտ', 'საგზაო ტრანსპორტი', 'रस्ता वाहतूक', 'Pengangkutan Jalan', 'ਸੜਕ ਆਵਾਜਾਈ', 'சாலை போக்குவரத்து', 'రహదారి రవాణా', 'Vägtransport', 'Transportasyon sa Daan');
INSERT INTO `languages` VALUES (172, 'photo', 'Photo', 'ছবি', 'صورة فوتوغرافية', 'photo', 'तस्वीर', 'Foto', 'Foto', '写真', '사진', 'Foto', 'foto', 'ภาพถ่าย', 'fotoğraf', 'تصویر', '照片', 'foto', 'Foto', 'φωτογραφία', 'Foto', 'फोटो', 'Фото', 'Foto', 'Լուսանկար', 'ფოტო', 'छायाचित्र', 'Foto', 'ਤਸਵੀਰ', 'புகைப்படம்', 'ఫోటో', 'Foto', 'Larawan');
INSERT INTO `languages` VALUES (173, 'select_class', 'Select Class', 'ক্লাস নির্বাচন', 'حدد فئة', 'Sélectionnez la classe', 'वर्ग का चयन', 'Pilih Kelas', 'Seleziona classe', 'クラスを選択します', '선택 클래스', 'Select Class', 'Selecionar classe', 'เลือกชั้นเรียน', 'seçin Sınıf', 'کلاس منتخب', '选择类别', 'Kies klas', 'Wählen Sie Klasse', 'Επιλέξτε τάξη', 'Seleccione clase', 'कक्षा चयन गर्नुहोस्', 'Выберите класс', 'Vælg klasse', 'Ընտրեք դաս', 'აირჩიეთ კლასი', 'वर्ग निवडा', 'Pilih Kelas', 'ਕਲਾਸ ਚੁਣੋ', 'வகுப்பைத் தேர்ந்தெடுக்கவும்', 'తరగతి ఎంచుకోండి', 'Välj klass', 'Piliin ang Klase');
INSERT INTO `languages` VALUES (174, 'username_password_incorrect', 'Username Or Password Is Incorrect', 'ব্যাবহারকারীর নাম অথবা গোপন নাম্বারটি ভুল', 'اسم المستخدم أو كلمة المرور غير صحيحة', 'L\'identifiant ou le mot de passe est incorrect', 'उपयोगकर्ता नाम या पासवर्ड गलत है', 'Nama pengguna atau kata sandi salah', 'Nome utente o password non sono corretti', 'ユーザー名かパスワードが間違っています', '사용자 이름 또는 암호가 올바르지 않습니다', 'Gebruikersnaam of wachtwoord is onjuist', 'Nome de usuário ou senha está incorreta', 'ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง', 'Kullanıcı adı veya şifre yanlış', 'صارف کا نام یا پاس ورڈ غلط ہے', '用户名或密码不正确', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (175, 'select_section', 'Select Section', 'অনুচ্ছেদ নির্বাচন', 'حدد القسم', 'Sélectionnez Section', 'अनुभाग का चयन', 'Pilih Bagian', 'Seleziona sezione', 'セクションを選択します', '선택 섹션', 'Select Section', 'Select Section', 'เลือกส่วน', 'seç Bölüm', 'سیکشن منتخب', '选择部分', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (176, 'options', 'Options', 'বিকল্প', 'خيارات', 'options de', 'विकल्प', 'Pilihan', 'Opzioni', 'オプション', '옵션', 'opties', 'opções', 'ตัวเลือก', 'Seçenekler', 'اختیارات', '选项', 'opsies', 'Optionen', 'Επιλογές', 'Opciones', 'विकल्पहरू', 'Опции', 'Muligheder', 'Ընտրանքներ', 'Პარამეტრები', 'पर्याय', 'Pilihan', 'ਚੋਣਾਂ', 'விருப்பங்கள்', 'ఎంపికలు', 'alternativ', 'Mga Pagpipilian');
INSERT INTO `languages` VALUES (177, 'mark_sheet', 'Mark Sheet', 'নাম্বার শিট', 'ورقة علامة', 'Mark Sheet', 'अंक तालिका', 'Lembar penilaian', 'Libretto universitario', 'マークシート', '마크 시트', 'Mark Sheet', 'Mark Sheet', 'มาร์คแผ่น', 'İşareti levha', 'مارک شیٹ', '标记表', 'Merkblad', 'Markierungsblatt', 'Φυλλάδιο απαντήσεων', 'Marcar hoja', 'मार्क पाना', 'Марк Шит', 'Mark Sheet', 'Մարկ Թերթիկը', 'Ნიშნის ფურცელი', 'गुणपत्रिका', 'Helaian Tandakan', 'ਮਾਰਕ ਸ਼ੀਟ', 'மதிப்பீட்டு தாள்', 'గణాంకాల పట్టి', 'Mark Sheet', 'Markahang papel');
INSERT INTO `languages` VALUES (178, 'profile', 'Profile', 'প্রোফাইলে', 'الملف الشخصي', 'Profil', 'प्रोफाइल', 'profil', 'Profilo', 'プロフィール', '윤곽', 'Profiel', 'Perfil', 'ข้อมูลส่วนตัว', 'Profil', 'پروفائل', '轮廓', 'profiel', 'Profil', 'Προφίλ', 'Perfil', 'प्रोफाइल', 'Профиль', 'Profil', 'Անձնագիր', 'პროფილი', 'प्रोफाइल', 'Profil', 'ਪ੍ਰੋਫਾਈਲ', 'சுயவிவரம்', 'ప్రొఫైల్', 'Profil', 'Profile');
INSERT INTO `languages` VALUES (179, 'select_all', 'Select All', 'সবগুলো নির্বাচন করা', 'اختر الكل', 'Sélectionner tout', 'सभी का चयन करे', 'Pilih Semua', 'Seleziona tutto', 'すべて選択', '모두 선택', 'Selecteer alles', 'Selecionar tudo', 'เลือกทั้งหมด', 'Hepsini seç', 'تمام منتخب کریں', '全选', 'Kies alles', 'Wählen Sie Alle', 'Επιλογή όλων', 'Seleccionar todo', 'सबै छान्नु', 'Выбрать все', 'Vælg alle', 'Ընտրել բոլորը', 'Მონიშნე ყველა', 'सर्व निवडा', 'Pilih semua', 'ਸਾਰਿਆ ਨੂੰ ਚੁਣੋ', 'அனைத்தையும் தெரிவுசெய்', 'అన్ని ఎంచుకోండి', 'Välj alla', 'Piliin lahat');
INSERT INTO `languages` VALUES (180, 'select_none', 'Select None', 'কিছুই না', 'حدد بلا', 'Ne rien sélectionner', 'किसी का चयन न करें', 'Pilih Tidak', 'Non selezionare niente', '何も選択しません', '선택 없음', 'Niets selecteren', 'Selecione nenhum', 'เลือกไม่มี', 'Hiçbir şey seçilmedi', 'کوئی بھی منتخب', '选择无', 'Kies Geen', 'Nichts ausgewählt', 'Επιλέξτε Κανένα', 'No seleccionar ninguno', 'कुनै पनि चयन नगर्नुहोस्', 'Выберите Нет', 'Vælg Ingen', 'Ընտրեք ոչ մեկը', 'აირჩიეთ არცერთი', 'काहीही निवडा', 'Pilih Tiada', 'ਕੋਈ ਨਹੀਂ ਚੁਣੋ', 'எதுவுமில்லை என்பதைத் தேர்ந்தெடுக்கவும்', 'ఏది కాదు', 'Välj ingen', 'Piliin ang Wala');
INSERT INTO `languages` VALUES (181, 'average', 'Average', 'গড়', 'متوسط', 'Moyenne', 'औसत', 'rata-rata', 'Media', '平均', '평균', 'Gemiddelde', 'Média', 'เฉลี่ย', 'Ortalama', 'اوسط', '平均', 'Gemiddeld', 'Durchschnittlich', 'Μέση τιμή', 'Promedio', 'औसत', 'Средний', 'Gennemsnit', 'Միջին', 'საშუალო', 'सरासरी', 'Rata-rata', '.ਸਤ', 'சராசரி', 'సగటు', 'Medel', 'Karaniwan');
INSERT INTO `languages` VALUES (182, 'transfer', 'Transfer', 'হস্তান্তর', 'تحويل', 'transfert', 'स्थानांतरण', 'transfer', 'trasferimento', '転送', '이전', 'overdracht', 'transferir', 'โอน', 'aktarma', 'منتقلی', '转让', 'oordrag', 'Transfer', 'ΜΕΤΑΦΟΡΑ', 'Transferir', 'स्थानान्तरण', 'Перечислить', 'Overførsel', 'Փոխանցում', 'Გადაცემა', 'हस्तांतरण', 'Pindah', 'ਟ੍ਰਾਂਸਫਰ', 'இடமாற்றம்', 'ట్రాన్స్ఫర్', 'Överföra', 'Transfer');
INSERT INTO `languages` VALUES (183, 'edit_teacher', 'Edit Teacher', 'গুরু সম্পাদনা', 'تحرير المعلم', 'Modifier enseignant', 'शिक्षक संपादित करें', 'mengedit Guru', 'Modifica Maestro', '編集教師', '편집 교사', 'Leraar bewerken', 'Editar professor', 'แก้ไขครู', 'Düzenleme Öğretmen', 'ٹیچر ترمیم کریں', '编辑老师', 'Wysig onderwyser', 'Lehrer bearbeiten', 'Επεξεργασία καθηγητή', 'Editar profesor', 'शिक्षक सम्पादन गर्नुहोस्', 'Редактировать Учителя', 'Rediger lærer', 'Խմբագրել ուսուցիչը', 'მასწავლებლის რედაქტირება', 'शिक्षक संपादित करा', 'Guru Sunting', 'ਸੋਧ ਅਧਿਆਪਕ', 'ஆசிரியரைத் திருத்து', 'గురువును సవరించండి', 'Redigera lärare', 'I-edit ang Guro');
INSERT INTO `languages` VALUES (184, 'sex', 'Sex', 'লিঙ্গ', 'جنس', 'Sexe', 'लिंग', 'Seks', 'Sesso', 'セックス', '섹스', 'Seks', 'Sexo', 'เพศ', 'Seks', 'جنس', '性别', 'seks', 'Sex', 'Φύλο', 'Sexo', 'सेक्स', 'секс', 'Køn', 'Սեռը', 'სექსი', 'लिंग', 'Seks', 'ਸੈਕਸ', 'செக்ஸ்', 'సెక్స్', 'Sex', 'Kasarian');
INSERT INTO `languages` VALUES (185, 'marksheet_for', 'Marksheet For', 'মার্ক শীট', 'ورقة علامة ل', 'Marquer les feuilles pour', 'Marksheet For', 'Mark lembar untuk', 'fogli marchio per', '用マークシート', '에 대한 마크 시트', 'Mark platen voor', 'Marcar folhas para', 'แผ่นมาร์คสำหรับ', 'Mark levhalar', 'Marksheet For', '马克薄板', 'Merkblad vir', 'Markenblatt für', 'Φύλλο σήματος για', 'Hoja de cálculo para', 'मार्कसिटका लागि', 'Marksheet для', 'Mærketegn for', 'Marksheet համար', 'Marksheet for', 'साठी मार्कशीट', 'Lembaran markah untuk', 'ਲਈ ਮਾਰਕਸ਼ੀਟ', 'க்கான மார்க்ஷீட்', 'కోసం మార్క్‌షీట్', 'Märkeark för', 'Marksheet para sa');
INSERT INTO `languages` VALUES (186, 'total_marks', 'Total Marks', 'মোট মার্কস', 'مجموع الدرجات', 'total de points', 'कुल मार्क', 'total Marks', 'Marks totali', '総マークス', '총 마크', 'Totaal Marks', 'total de Marcas', 'Marks รวม', 'Toplam Marks', 'کل مارکس', '总分', 'Totale punte', 'Gesamtnoten', 'Σύνολο σημείων', 'Notas totales', 'कुल मार्कहरू', 'Всего знаков', 'Samlede mærker', 'Ընդհանուր նշաններ', 'სულ ნიშნები', 'एकूण गुण', 'Jumlah Markah', 'ਕੁੱਲ ਅੰਕ', 'மொத்த மதிப்பெண்கள்', 'మొత్తం మార్కులు', 'Totalt betyg', 'Kabuuang Mga Marko');
INSERT INTO `languages` VALUES (187, 'parent_phone', 'Parent Phone', 'পেরেন্ট ফোন', 'الأم الهاتف', 'Parent téléphone', 'माता पिता के फोन', 'induk Telepon', 'Parent Phone', '親の携帯電話', '부모 전화', 'Parent Phone', 'pais Telefone', 'ผู้ปกครองโทรศัพท์', 'Veli Telefon', 'والدین فون', '家长电话', 'Ouerfoon', 'Übergeordnetes Telefon', 'Μητρικό τηλέφωνο', 'Teléfono de los padres', 'अभिभावक फोन', 'Родительский телефон', 'Overordnet telefon', 'Ծնողների հեռախոս', 'მშობლის ტელეფონი', 'मूळ फोन', 'Telefon Ibu Bapa', 'ਮੁੱ Phoneਲਾ ਫੋਨ', 'பெற்றோர் தொலைபேசி', 'తల్లిదండ్రుల ఫోన్', 'Föräldertelefon', 'Telepono ng Magulang');
INSERT INTO `languages` VALUES (188, 'subject_author', 'Subject Author', 'বিষয় লেখক', 'الموضوع المؤلف', 'Sujet Auteur', 'विषय लेखक', 'Subjek Penulis', 'Autore del soggetto', 'テーマ作成者', '제목 작성자', 'Onderwerp Auteur', 'Assunto Autor', 'ผู้แต่งเรื่อง', 'Konu Yazar', 'موضوع مصنف', '主题作者', 'Vakskrywer', 'Betreff Autor', 'Θέμα Συγγραφέας', 'Autor sujeto', 'विषय लेखक', 'Автор темы', 'Emne forfatter', 'Առարկայի հեղինակ', 'საგნის ავტორი', 'विषय लेखक', 'Pengarang Subjek', 'ਵਿਸ਼ਾ ਲੇਖਕ', 'பொருள் ஆசிரியர்', 'విషయం రచయిత', 'Ämnesförfattare', 'May-akda ng Paksa');
INSERT INTO `languages` VALUES (189, 'update', 'Update', 'হালনাগাদ', 'تحديث', 'Mettre à jour', 'अपडेट', 'Memperbarui', 'Aggiornare', '更新', '최신 정보', 'Bijwerken', 'Atualizar', 'ปรับปรุง', 'Güncelleştirme', 'اپ ڈیٹ', '更新', 'Opdateer', 'Aktualisieren', 'Εκσυγχρονίζω', 'Actualizar', 'अद्यावधिक गर्नुहोस्', 'Обновить', 'Opdatering', 'Թարմացում', 'განახლება', 'अद्यतनित करा', 'Kemas kini', 'ਅਪਡੇਟ', 'புதுப்பிப்பு', 'నవీకరణ', 'Uppdatering', 'I-update');
INSERT INTO `languages` VALUES (190, 'class_list', 'Class List', 'ক্লাস তালিকা', 'قائمة الطبقة', 'Liste des classes', 'कक्षा सूची', 'Daftar kelas', 'Lista Class', 'クラス一覧', '클래스 목록', 'class List', 'Lista de Classes', 'รายการระดับ', 'sınıf listesi', 'کلاس کی فہرست', '班级列表', 'Klaslys', 'Klassenliste', 'Λίστα τάξεων', 'Lista de clase', 'वर्ग सूची', 'Список классов', 'Klasseliste', 'Դասերի ցուցակ', 'კლასების სია', 'वर्ग यादी', 'Senarai Kelas', 'ਕਲਾਸ ਲਿਸਟ', 'வகுப்பு பட்டியல்', 'తరగతి జాబితా', 'Klasslista', 'Listahan ng Klase');
INSERT INTO `languages` VALUES (191, 'class_name', 'Class Name', 'শ্রেণির নাম', 'اسم الطبقة', 'Nom du cours', 'कक्षा का नाम', 'Nama kelas', 'Nome della classe', 'クラス名', '클래스 이름', 'Naam van de klasse', 'Nome da classe', 'ชื่อชั้น', 'Sınıf adı', 'کلاس نام', '类名', 'Klasnaam', 'Klassenname', 'Ονομα τάξης', 'Nombre de la clase', 'कक्षाको नाम', 'Имя класса', 'Klasse Navn', 'Դասի անվանումը', 'კლასის სახელი', 'वर्गाचे नाव', 'Nama Kelas', 'ਕਲਾਸ ਦਾ ਨਾਮ', 'வகுப்பு பெயர்', 'తరగతి పేరు', 'Klassnamn', 'Pangalan ng klase');
INSERT INTO `languages` VALUES (192, 'name_numeric', 'Name Numeric', 'নাম সংখ্যাসূচক', 'اسم الرقمية', 'Nom numérique', 'नाम संख्यात्मक', 'nama Numeric', 'nome numerico', '名前数値', '이름 숫자', 'naam Numeriek', 'nome numérico', 'ชื่อตัวเลข', 'isim Sayısal', 'نام نمبری', '名称数字', 'Noem numeries', 'Name Numerisch', 'Όνομα αριθμητικό', 'Nombre numérico', 'नाम संख्यात्मक', 'Имя Числовое', 'Navn Numerisk', 'Անվան թվանշան', 'სახელი რიცხვითი', 'नाव सांख्यिक', 'Namakan Numerik', 'ਨਾਮ ਸੰਖਿਆਤਮਕ', 'பெயர் எண்', 'పేరు సంఖ్యా', 'Namn numeriskt', 'Pangalan ng Numeric');
INSERT INTO `languages` VALUES (193, 'select_teacher', 'Select Teacher', 'গুরু নির্বাচন', 'حدد المعلم', 'Sélectionnez ce professeur', 'शिक्षक का चयन', 'Pilih Guru', 'Seleziona insegnante', '教師を選択', '선택 교사', 'Selecteer Teacher', 'Escolha um professor', 'เลือกครู', 'seçin Öğretmen', 'ٹیچر منتخب', '选择教师', 'Kies Onderwyser', 'Wählen Sie Lehrer', 'Επιλέξτε Δάσκαλος', 'Seleccionar profesor', 'शिक्षक चयन गर्नुहोस्', 'Выберите учителя', 'Vælg Lærer', 'Ընտրեք Ուսուցիչ', 'შეარჩიეთ მასწავლებელი', 'शिक्षक निवडा', 'Pilih Guru', 'ਅਧਿਆਪਕ ਦੀ ਚੋਣ ਕਰੋ', 'ஆசிரியரைத் தேர்ந்தெடுக்கவும்', 'గురువును ఎంచుకోండి', 'Välj lärare', 'Piliin ang Guro');
INSERT INTO `languages` VALUES (194, 'edit_class', 'Edit Class', 'ক্লাস সম্পাদনা', 'تحرير الفئة', 'Modifier la classe', 'कक्षा संपादित करें', 'mengedit Kelas', 'Modifica Class', '編集クラス', '편집 클래스', 'klasse bewerken', 'Editar Classe', 'แก้ไขชั้น', 'Düzenleme Sınıfı', 'تصیح کلاس', '编辑类', 'Klas wysig', 'Klasse bearbeiten', 'Επεξεργασία τάξης', 'Editar clase', 'कक्षा सम्पादन गर्नुहोस्', 'Редактировать класс', 'Rediger klasse', 'Խմբագրել դասը', 'რედაქტირების კლასი', 'वर्ग संपादित करा', 'Edit Kelas', 'ਕਲਾਸ ਸੰਪਾਦਿਤ ਕਰੋ', 'வகுப்பைத் திருத்து', 'తరగతిని సవరించండి', 'Redigera klass', 'I-edit ang Klase');
INSERT INTO `languages` VALUES (195, 'section_name', 'Section Name', 'অনুচ্ছেদ নাম', 'اسم القسم', 'Nom de la section', 'अनुभाग का नाम', 'bagian Nama', 'Nome sezione', 'セクション名', '섹션 이름', 'sectie Naam', 'Nome da seção', 'ส่วนชื่อ', 'bölüm Adı', 'حصے کا نام', '部分名称', 'Afdelingsnaam', 'Abteilungsname', 'Όνομα ενότητας', 'Nombre de la sección', 'सेक्सन नाम', 'Название раздела', 'Sektionsnavn', 'Բաժնի անվանումը', 'განყოფილების სახელი', 'विभाग नाव', 'Nama Bahagian', 'ਭਾਗ ਦਾ ਨਾਮ', 'பிரிவு பெயர்', 'విభాగం పేరు', 'Avdelningsnamn', 'Pangalan ng Seksyon');
INSERT INTO `languages` VALUES (196, 'add_section', 'Add Section', 'অনুচ্ছেদ যোগ', 'إضافة مقطع', 'Ajouter Section', 'धारा जोड़े', 'Tambahkan Bagian', 'Aggiungere Sezione', 'セクションを追加します。', '섹션 추가', 'Sectie toevoegen', 'Adicionar Seção', 'เพิ่มส่วน', 'Bölüm ekle', 'سیکشن کا اضافہ کریں', '添加章节', 'Voeg afdeling by', 'Abschnitt hinzufügen', 'Προσθήκη ενότητας', 'Agregar sección', 'सेक्सन जोड्नुहोस्', 'Добавить раздел', 'Tilføj sektion', 'Ավելացնել բաժին', 'სექციის დამატება', 'विभाग जोडा', 'Tambah Bahagian', 'ਭਾਗ ਸ਼ਾਮਲ ਕਰੋ', 'பிரிவைச் சேர்க்கவும்', 'విభాగాన్ని జోడించండి', 'Lägg till avsnitt', 'Magdagdag ng Seksyon');
INSERT INTO `languages` VALUES (197, 'subject_list', 'Subject List', 'বিষয় তালিকা', 'قائمة الموضوع', 'Liste Sujet', 'विषय सूची', 'Daftar subjek', 'soggetto List', '件名一覧', '주제 목록', 'subject List', 'Assunto Lista', 'รายการหัวเรื่อง', 'Konu listesi', 'موضوع لسٹ', '主题列表', 'Vaklys', 'Betreffliste', 'Λίστα θεμάτων', 'Lista de temas', 'विषय सूची', 'Список тем', 'Emneliste', 'Առարկաների ցուցակը', 'საგნების სია', 'विषय यादी', 'Senarai Subjek', 'ਵਿਸ਼ਾ ਸੂਚੀ', 'பொருள் பட்டியல்', 'విషయ జాబితా', 'Ämneslista', 'Listahan ng Paksa');
INSERT INTO `languages` VALUES (198, 'subject_name', 'Subject Name', 'বিষয় নাম', 'اسم الموضوع', 'Nom Sujet', 'विषय नाम', 'Nama subjek', 'soggetto Nome', 'サブジェクト名', '주체 이름', 'onderwerp Naam', 'Nome Assunto', 'ชื่อเรื่อง', 'Konu Adı', 'موضوع کا نام', '主题名称', 'Onderwerpnaam', 'Subjekt Name', 'Όνομα θέματος', 'Nombre del tema', 'बिषय नाम', 'Имя субъекта', 'Emne navn', 'Առարկայի անունը', 'საგნის სახელი', 'विषयाचे नाव', 'Nama Subjek', 'ਵਿਸ਼ਾ ਨਾਮ', 'பொருள் பெயர்', 'విషయం పేరు', 'Ämnesnamn', 'Pangalan ng Paksa');
INSERT INTO `languages` VALUES (199, 'edit_subject', 'Edit Subject', 'বিষয় সম্পাদনা', 'تحرير الموضوع', 'Modifier Objet', 'विषय संपादित करें', 'Edit Perihal', 'Modifica oggetto', '編集件名', '편집 주제', 'Onderwerp bewerken', 'Editar assunto', 'แก้ไขเรื่อง', 'Konu Düzenle', 'موضوع میں ترمیم کریں', '编辑主题', 'Wysig onderwerp', 'Betreff bearbeiten', 'Επεξεργασία θέματος', 'Editar asunto', 'विषय सम्पादन गर्नुहोस्', 'Изменить тему', 'Rediger emne', 'Խմբագրել առարկան', 'საგნის რედაქტირება', 'विषय संपादित करा', 'Edit Subjek', 'ਵਿਸ਼ਾ ਸੋਧੋ', 'பொருளைத் திருத்து', 'విషయాన్ని సవరించండి', 'Redigera ämne', 'I-edit ang Paksa');
INSERT INTO `languages` VALUES (200, 'day', 'Day', 'দিন', 'يوم', 'journée', 'दिन', 'Hari', 'Giorno', '日', '일', 'Dag', 'Dia', 'วัน', 'Gün', 'ڈے', '天', 'dag', 'Tag', 'Ημέρα', 'Día', 'दिन', 'День', 'Dag', 'Օր', 'Დღეს', 'दिवस', 'Hari', 'ਦਿਨ', 'நாள்', 'డే', 'Dag', 'Araw');
INSERT INTO `languages` VALUES (201, 'starting_time', 'Starting Time', 'সময় শুরু', 'ابتداء من الوقت', 'Heure de départ', 'प्रारम्भ का समय', 'Waktu mulai', 'Tempo di partenza', '起動時間', '시간 시작', 'Starttijd', 'Tempo de partida', 'เวลาเริ่มต้น', 'Başlangıç ​​zamanı', 'وقت پر شروع', '开始时间', 'Aanvangstyd', 'Anfangszeit', 'Ωρα έναρξης', 'Tiempo de empezar', 'सुरु हुने समय', 'Время начала', 'Starttidspunkt', 'Մեկնարկի ժամանակը', 'დაწყების დრო', 'प्रारंभ वेळ', 'Masa Bermula', 'ਅਰੰਭ ਕਰਨ ਦਾ ਸਮਾਂ', 'தொடக்க நேரம்', 'ప్రారంభ సమయం', 'Starttid', 'Panimulang Panahon');
INSERT INTO `languages` VALUES (202, 'hour', 'Hour', 'ঘন্টা', 'ساعة', 'Heure', 'समय', 'Jam', 'Ora', '時間', '시간', 'Uur', 'Hora', 'ชั่วโมง', 'Saat', 'قیامت', '小时', 'Uur', 'Stunde', 'Ωρα', 'Hora', 'घण्टा', 'Час', 'Time', 'Ժամ', 'საათში', 'तास', 'Jam', 'ਘੰਟਾ', 'மணி', 'అవర్', 'Timme', 'Oras');
INSERT INTO `languages` VALUES (203, 'minutes', 'Minutes', 'মিনিট', 'دقيقة', 'Minutes', 'मिनट', 'Menit', 'Minuti', '分', '의사록', 'Notulen', 'Minutos', 'รายงานการประชุม', 'dakika', 'منٹس', '纪要', 'Minute', 'Protokoll', 'Λεπτά', 'Minutos', 'मिनेट', 'минут', 'minutter', 'Րոպեներ', 'წუთები', 'मिनिटे', 'Minit', 'ਮਿੰਟ', 'நிமிடங்கள்', 'నిమిషాలు', 'Minuter', 'Mga Minuto');
INSERT INTO `languages` VALUES (204, 'ending_time', 'Ending Time', 'সময় শেষ', 'إنهاء الوقت', 'Fin Temps', 'अंतिम समय', 'akhir Waktu', 'Fine Tempo', '終了時刻', '시간 종료', 'Ending Time', 'Tempo Final', 'เวลาสิ้นสุด', 'Zaman Bitiş', 'وقت ختم', '结束时间', 'Eindtyd', 'Endzeit', 'Ώρα λήξης', 'Tiempo final', 'अन्त हुने समय', 'Время окончания', 'Slutter tid', 'Ավարտելու ժամանակը', 'დასრულების დრო', 'समाप्ती वेळ', 'Masa Berakhir', 'ਖ਼ਤਮ ਹੋਣ ਦਾ ਸਮਾਂ', 'முடிவடையும் நேரம்', 'సమయం ముగిసింది', 'Avslutande tid', 'Pagtatapos ng Oras');
INSERT INTO `languages` VALUES (205, 'select_subject', 'Select Subject', 'বিষয় নির্বাচন করুন', 'حدد الموضوع', 'Sélectionnez Objet', 'विषय का चयन', 'Pilih Jurusan', 'Selezionare Oggetto', '件名を選択', '선택 주제', 'Selecteer Onderwerp', 'Selecione Assunto', 'เลือกสาขาวิชา', 'Konu seçin', 'موضوع منتخب', '选择主题', 'Kies onderwerp', 'Wählen Sie Betreff', 'Επιλέξτε Θέμα', 'Seleccione Asunto', 'विषय चयन गर्नुहोस्', 'Выберите тему', 'Vælg emne', 'Ընտրեք Առարկան', 'აირჩიეთ თემა', 'विषय निवडा', 'Pilih Subjek', 'ਵਿਸ਼ਾ ਚੁਣੋ', 'பொருள் தேர்ந்தெடுக்கவும்', 'విషయం ఎంచుకోండి', 'Välj ämne', 'Piliin ang Paksa');
INSERT INTO `languages` VALUES (206, 'select_date', 'Select Date', 'তারিখ নির্বাচন করুন', 'حدد التاريخ', 'Sélectionnez date', 'तारीख़ चुनें', 'Pilih Tanggal', 'Selezionare Data', '日付を選択', '날짜 선택', 'Datum selecteren', 'Selecione Data', 'เลือกวันที่', 'seçin tarihi', 'تاریخ منتخب', '选择日期', 'Kies Datum', 'Datum auswählen', 'Επιλέξτε Ημερομηνία', 'Seleccione fecha', 'मिति चयन गर्नुहोस्', 'Выберите дату', 'Vælg dato', 'Ընտրեք Ամսաթիվ', 'აირჩიეთ თარიღი', 'तारीख निवडा', 'Pilih Tarikh', 'ਮਿਤੀ ਦੀ ਚੋਣ ਕਰੋ', 'தேதி தேர்ந்தெடுக்கவும்', 'తేదీని ఎంచుకోండి', 'Välj datum', 'Piliin ang Petsa');
INSERT INTO `languages` VALUES (207, 'select_month', 'Select Month', 'মাস নির্বাচন করুন', 'اختر الشهر', 'Sélectionnez un mois', 'महीना चुनिए', 'Pilih Bulan', 'Selezionare il mese', '月を選択', '월을 선택', 'Selecteer maand', 'Selecione o mês', 'เลือกเดือน', 'Ay seç', 'مہینہ منتخب کریں', '选择月份', 'Kies maand', 'Wähle einen Monat', 'Επιλέξτε μήνα', 'Seleccione mes', 'महिना चयन गर्नुहोस्', 'Выберите месяц', 'Vælg måned', 'Ընտրեք ամիս', 'აირჩიეთ თვე', 'महिना निवडा', 'Pilih Bulan', 'ਮਹੀਨਾ ਚੁਣੋ', 'மாதத்தைத் தேர்ந்தெடுக்கவும்', 'నెల ఎంచుకోండి', 'Välj månad', 'Piliin ang Buwan');
INSERT INTO `languages` VALUES (208, 'select_year', 'Select Year', 'নির্বাচন বছর', 'اختر السنة', 'Sélectionnez Année', 'चयन वर्ष', 'pilih Tahun', 'Seleziona Anno', '年を選択', '년도 선택', 'Selecteer Jaar', 'Selecione o ano', 'เลือกปี', 'Yıl seçin', 'چھانٹیں کریں', '选择年份', 'Kies jaar', 'Wählen Sie Jahr', 'Επιλέξτε Έτος', 'Seleccione año', 'वर्ष चयन गर्नुहोस्', 'Выберите год', 'Vælg år', 'Ընտրեք տարին', 'აირჩიეთ წელი', 'वर्ष निवडा', 'Pilih Tahun', 'ਸਾਲ ਚੁਣੋ', 'ஆண்டு தேர்ந்தெடுக்கவும்', 'సంవత్సరాన్ని ఎంచుకోండి', 'Välj år', 'Piliin ang Taon');
INSERT INTO `languages` VALUES (209, 'add_language', 'Add Language', 'ভাষা যোগ করুন', 'إضافة لغة', 'ajouter une langue', 'भाषा जोड़ें', 'tambahkan bahasa', 'aggiungere la lingua', '言語を追加する', '언어 추가', 'taal toevoegen', 'adicionar linguagem', 'เพิ่มภาษา', 'dil ekle', 'زبان شامل کریں', '添加语言', 'Voeg taal by', 'Sprache hinzufügen', 'Προσθήκη γλώσσας', 'Agregar idioma', 'भाषा थप्नुहोस्', 'Добавить язык', 'Tilføj sprog', 'Լեզուն ավելացնել', 'ენის დამატება', 'भाषा जोडा', 'Tambah Bahasa', 'ਭਾਸ਼ਾ ਸ਼ਾਮਲ ਕਰੋ', 'மொழி சேர்க்கவும்', 'భాషను జోడించండి', 'Lägg till språk', 'Magdagdag ng Wika');
INSERT INTO `languages` VALUES (210, 'exam_name', 'Exam Name', 'পরীক্ষার নাম', 'اسم الامتحان', 'Nom d\'examen', 'परीक्षा का नाम', 'ujian Nama', 'Nome esame', '試験名', '시험 이름', 'examen Naam', 'exame Nome', 'ชื่อสอบ', 'sınav Adı', 'امتحان نام', '考试名称', 'Eksamennaam', 'Prüfungsname', 'Όνομα εξέτασης', 'Nombre del examen', 'परीक्षा नाम', 'Имя экзамена', 'Eksamen Navn', 'Քննության անվանումը', 'გამოცდის სახელი', 'परीक्षेचे नाव', 'Nama Peperiksaan', 'ਪ੍ਰੀਖਿਆ ਦਾ ਨਾਮ', 'தேர்வு பெயர்', 'పరీక్ష పేరు', 'Examensnamn', 'Pangalan ng Exam');
INSERT INTO `languages` VALUES (211, 'date', 'Date', 'তারিখ', 'تاريخ', 'date', 'तारीख', 'Tanggal', 'Data', '日付', '날짜', 'Datum', 'Encontro', 'วันที่', 'tarih', 'تاریخ', '日期', 'datum', 'Datum', 'Ημερομηνία', 'Fecha', 'मिति', 'Свидание', 'Dato', 'Ամսաթիվ', 'თარიღი', 'तारीख', 'Tarikh', 'ਤਾਰੀਖ਼', 'தேதி', 'తేదీ', 'Datum', 'Petsa');
INSERT INTO `languages` VALUES (212, 'comment', 'Comment', 'মন্তব্য', 'التعليق', 'Commentaire', 'टिप्पणी', 'Komentar', 'Commento', 'コメント', '논평', 'Commentaar', 'Comente', 'คิดเห็น', 'Yorum', 'تبصرہ', '评论', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (213, 'edit_exam', 'Edit Exam', 'পরীক্ষার সম্পাদনা', 'تحرير امتحان', 'Modifier examen', 'परीक्षा संपादित करें', 'mengedit Ujian', 'Modifica esame', '編集試験', '편집 시험', 'Examen bewerken', 'Editar Exame', 'แก้ไขการสอบ', 'Düzenleme Sınavı', 'امتحان میں ترمیم کریں', '编辑考试', 'Redigeer eksamen', 'Prüfung bearbeiten', 'Επεξεργασία εξέτασης', 'Editar examen', 'परीक्षा सम्पादन गर्नुहोस्', 'Редактировать экзамен', 'Rediger eksamen', 'Խմբագրել քննությունը', 'გამოცდის რედაქტირება', 'परीक्षा संपादित करा', 'Edit Peperiksaan', 'ਪ੍ਰੀਖਿਆ ਸੋਧੋ', 'தேர்வைத் திருத்து', 'పరీక్షను సవరించండి', 'Redigera tentamen', 'I-edit ang Exam');
INSERT INTO `languages` VALUES (214, 'grade_list', 'Grade List', 'গ্রেড তালিকা', 'قائمة الصف', 'Liste de grade', 'ग्रेड सूची', 'Daftar kelas', 'Lista grado', 'グレード一覧', '학년 목록', 'Grade List', 'Lista Grade', 'รายการเกรด', 'sınıf listesi', 'گریڈ کی فہرست', '等级名单', 'Graadlys', 'Notenliste', 'Λίστα βαθμού', 'Lista de calificaciones', 'ग्रेड सूची', 'Список оценок', 'Karakterliste', 'Դասարանների ցուցակ', 'კლასების სია', 'ग्रेड यादी', 'Senarai Gred', 'ਗ੍ਰੇਡ ਸੂਚੀ', 'தர பட்டியல்', 'గ్రేడ్ జాబితా', 'Betygslista', 'Listahan ng Baitang');
INSERT INTO `languages` VALUES (215, 'grade_name', 'Grade Name', 'গ্রেড নাম', 'اسم الصف', 'Nom de grade', 'ग्रेड नाम', 'Nama kelas', 'Nome grado', 'グレード名', '학년 이름', 'Grade Naam', 'Nome grau', 'ชื่อชั้นประถมศึกษา', 'Sınıf Adı', 'گریڈ نام', '牌号名称', 'Graadnaam', 'Notenname', 'Όνομα βαθμού', 'Nombre de grado', 'ग्रेड नाम', 'Название класса', 'Karakternavn', 'Դասարանի անուն', 'კლასის სახელწოდება', 'ग्रेड नाव', 'Nama Gred', 'ਗ੍ਰੇਡ ਦਾ ਨਾਮ', 'தரத்தின் பெயர்', 'గ్రేడ్ పేరు', 'Betygsnamn', 'Pangalan ng grado');
INSERT INTO `languages` VALUES (216, 'grade_point', 'Grade Point', 'গ্রেড পয়েন্ট', 'الصف نقطة', 'grade point', 'ग्रेड बिंदु', 'Indeks Prestasi', 'Grade Point', 'グレードポイント', '학점', 'Grade Point', 'Ponto de classificação', 'เกรด', 'not', 'گریڈ نقطہ', '绩点', 'Graadpunt', 'Notenpunkt', 'Βαθμός βαθμού', 'Punto de grado', 'ग्रेड पोइन्ट', 'Grade Point', 'Grad Point', 'Դասարանի կետ', 'Grade Point', 'ग्रेड पॉईंट', 'Titik Gred', 'ਗ੍ਰੇਡ ਪੁਆਇੰਟ', 'கிரேடு பாயிண்ட்', 'గ్రేడ్ పాయింట్', 'Betygspoäng', 'Baitang ng Baitang');
INSERT INTO `languages` VALUES (217, 'select_exam', 'Select Exam', 'পরীক্ষার নির্বাচন', 'حدد الامتحان', 'Sélectionnez Exam', 'परीक्षा का चयन', 'Pilih Ujian', 'Selezionare esame', '試験を選択', '선택의 시험', 'Selecteer Examen', 'Select Exam', 'เลือกสอบ', 'seç Sınav', 'امتحان منتخب', '选择考试', 'Kies eksamen', 'Wählen Sie Prüfung', 'Επιλέξτε Εξέταση', 'Seleccionar examen', 'परीक्षा चयन गर्नुहोस्', 'Выберите экзамен', 'Vælg eksamen', 'Ընտրեք քննություն', 'შეარჩიე გამოცდა', 'परीक्षा निवडा', 'Pilih Peperiksaan', 'ਇਮਤਿਹਾਨ ਦੀ ਚੋਣ ਕਰੋ', 'தேர்வு என்பதைத் தேர்ந்தெடுக்கவும்', 'పరీక్షను ఎంచుకోండి', 'Välj tentamen', 'Piliin ang Exam');
INSERT INTO `languages` VALUES (218, 'students', 'Students', 'শিক্ষার্থীরা', 'الطلاب', 'Élèves', 'छात्र', 'siswa', 'Alunni', '学生の', '재학생', 'leerlingen', 'estudantes', 'นักเรียน', 'Öğrenciler', 'طلباء', '学生们', 'Studente', 'Studenten', 'Φοιτητές', 'Estudiantes', 'विद्यार्थी', 'Студенты', 'Studerende', 'Ուսանողները', 'სტუდენტებს', 'विद्यार्थीच्या', 'Pelajar', 'ਵਿਦਿਆਰਥੀ', 'மாணவர்கள்', 'స్టూడెంట్స్', 'studenter', 'Mga mag-aaral');
INSERT INTO `languages` VALUES (219, 'subjects', 'Subjects', 'প্রজাদের', 'المواضيع', 'Sujets', 'विषयों', 'subyek', 'Soggetti', '科目', '주제', 'vakken', 'assuntos', 'อาสาสมัคร', 'Konular', 'مضامین', '主题', 'vakke', 'Themen', 'μαθήματα', 'Asignaturas', 'विषयहरु', 'Предметы', 'emner', 'Առարկաներ', 'საგნები', 'विषय', 'Mata pelajaran', 'ਵਿਸ਼ੇ', 'பாடங்கள்', 'విషయము', 'ämnen', 'Mga Paksa');
INSERT INTO `languages` VALUES (220, 'total', 'Total', 'মোট', 'مجموع', 'Total', 'कुल', 'Total', 'Totale', '合計', '합계', 'Totaal', 'Total', 'ทั้งหมด', 'Toplam', 'کل', '总', 'totale', 'Gesamt', 'Σύνολο', 'Total', 'कुल', 'Всего', 'Total', 'Ընդհանուր', 'სულ', 'एकूण', 'Jumlah', 'ਕੁੱਲ', 'மொத்தம்', 'మొత్తం', 'Total', 'Kabuuan');
INSERT INTO `languages` VALUES (221, 'select_academic_session', 'Select Academic Session', 'একাডেমিক সেশন নির্বাচন', 'حدد الدورة الأكاديمية', 'Séance scolaire sélectionnée', 'अकादमिक सत्र का चयन करें', 'Pilih sesi akademik', 'Selezionare sessione accademica', '学会を選択する', '학술회의 선택', 'Selecteer een academische sessie', 'Selecione a sessão acadêmica', 'เลือกเซสชันการศึกษา', 'Akademik oturumu seç', 'تعلیمی سیشن کا انتخاب کریں', '选择学术会议', 'Kies Akademiese Sessie', 'Wählen Sie Akademische Sitzung', 'Επιλέξτε Ακαδημαϊκή συνεδρία', 'Seleccione sesión académica', 'शैक्षिक सत्र चयन गर्नुहोस्', 'Выберите академическую сессию', 'Vælg akademisk session', 'Ընտրեք գիտական ​​նստաշրջան', 'აირჩიეთ აკადემიური სესია', 'शैक्षणिक सत्र निवडा', 'Pilih Sesi Akademik', 'ਅਕਾਦਮਿਕ ਸੈਸ਼ਨ ਦੀ ਚੋਣ ਕਰੋ', 'கல்வி அமர்வைத் தேர்ந்தெடுக்கவும்', 'అకడమిక్ సెషన్ ఎంచుకోండి', 'Välj akademisk session', 'Piliin ang Pang-akademikong Session');
INSERT INTO `languages` VALUES (222, 'invoice_informations', 'Invoice Informations', 'চালান ইনফরমেশন', 'معلومات الفاتورة', 'Informations de facturation', 'चालान जानकारी', 'Informasi faktur', 'Informazioni fattura', '請求書情報', '송장 정보', 'factuur Informations', 'Informações factura', 'ข้อมูลใบแจ้งหนี้', 'fatura Bilgileri', 'انوائس کی معلومات', '发票信息', 'Faktuurinligting', 'Rechnungsinformationen', 'Πληροφορίες τιμολογίου', 'Informaciones de factura', 'इनभ्वाइस सूचनाहरू', 'Информация о счете', 'Fakturainformation', 'Տեղեկատվություն հաշիվ-ապրանքագրի մասին', 'ინვოისის შესახებ ინფორმაცია', 'चलन माहिती', 'Maklumat Invois', 'ਇਨਵੌਇਸ ਜਾਣਕਾਰੀ', 'விலைப்பட்டியல் தகவல்கள்', 'ఇన్వాయిస్ సమాచారం', 'Fakturainformation', 'Mga Impormasyon sa Invoice');
INSERT INTO `languages` VALUES (223, 'title', 'Title', 'খেতাব', 'عنوان', 'Titre', 'शीर्षक', 'Judul', 'Titolo', 'タイトル', '표제', 'Titel', 'Título', 'หัวข้อ', 'başlık', 'عنوان', '标题', 'Titel', 'Titel', 'Τίτλος', 'Título', 'शीर्षक', 'заглавие', 'Titel', 'Կոչում', 'სათაური', 'शीर्षक', 'Tajuk', 'ਸਿਰਲੇਖ', 'தலைப்பு', 'శీర్షిక', 'Titel', 'Pamagat');
INSERT INTO `languages` VALUES (224, 'description', 'Description', 'বিবরণ', 'وصف', 'La description', 'विवरण', 'Deskripsi', 'Descrizione', '説明', '기술', 'Beschrijving', 'Descrição', 'ลักษณะ', 'tanım', 'تفصیل', '描述', 'beskrywing', 'Beschreibung', 'Περιγραφή', 'Descripción', 'वर्णन', 'Описание', 'Beskrivelse', 'Նկարագրություն', 'აღწერა', 'वर्णन', 'Penerangan', 'ਵੇਰਵਾ', 'விளக்கம்', 'వివరణ', 'Beskrivning', 'Paglalarawan');
...
INSERT INTO `languages` VALUES (226, 'view_invoice', 'View Invoice', 'দেখুন চালান', 'عرض الفاتورة', 'Voir la facture', 'चालान देखें', 'Lihat Faktur', 'Visualizza fattura', '請求書を見ます', '보기 송장', 'Bekijk Factuur', 'Ver Invoice', 'ดูใบแจ้งหนี้', 'Görünüm Fatura', 'لنک انوائس', '查看发票', 'Bekyk faktuur', 'Rechnung anzeigen', 'Προβολή τιμολογίου', 'Mirar la factura', 'चलानी हेर्नुहोस्', 'Посмотреть счет', 'Se faktura', 'Դիտեք հաշիվ-ապրանքագիր', 'ინვოისის ნახვა', 'बीजक पहा', 'Lihat Invois', 'ਚਲਾਨ ਵੇਖੋ', 'விலைப்பட்டியல் காண்க', 'ఇన్వాయిస్ చూడండి', 'Visa faktura', 'Tingnan ang Invoice');
INSERT INTO `languages` VALUES (227, 'payment_to', 'Payment To', 'পরিশোদ করা', 'دفع ل', 'Paiement à', 'को भुगतान', 'pembayaran untuk', 'pagamento a', 'への支払い', '로 지불', 'Betaling aan', 'Pagamento para', 'การชำระเงิน', 'Için ödeme', 'کرنے کے لئے ادائیگی', '支付', 'Betaling aan', 'Zahlung an', 'Πληρωμή σε', 'Pago Para', 'भुक्तानी गर्न', 'Оплата Для', 'betaling til', 'Վճարը', 'გადახდა', 'रक्कम अदा', 'bayaran kepada', 'ਨੂੰ ਭੁਗਤਾਨ', 'கட்டணம் கட்ட', 'చెల్లింపు', 'Betalning till', 'bayad sa');
INSERT INTO `languages` VALUES (228, 'bill_to', 'Bill To', 'বিল করতে', 'فاتورة الى', 'Facturer', 'बिल प्राप्तकर्ता', 'Pembayaran kepada', 'Fatturare a', '請求書送付先', '빌로', 'Rekening naar', 'Projeto de lei para', 'ส่งเบิกไปที่', 'Ya fatura edilecek', 'کا بل', '记账到', 'Rekening aan', 'Gesetzesentwurf für', 'Μπιλ', 'Cobrar a', 'यसमा बिल चढाउँनु', 'Плательщик', 'Regning til', 'Bill To', 'Კანონპროექტი', 'बिल करा', 'Bil Kepada', 'ਬਿਲ ਕਰੋ', 'பில் டு', 'బిల్ టు', 'Bill till', 'Bill To');
INSERT INTO `languages` VALUES (229, 'total_amount', 'Total Amount', 'সর্বমোট পরিমাণ', 'المبلغ الإجمالي', 'Montant total', 'कुल रकम', 'Jumlah total', 'Importo totale', '合計金額', '총액', 'Totaalbedrag', 'Valor total', 'จำนวนเงินรวม', 'Toplam tutar', 'کل رقم', '总金额', 'Rekening aan', 'Gesetzesentwurf für', 'Μπιλ', 'Cobrar a', 'यसमा बिल चढाउँनु', 'Плательщик', 'Regning til', 'Bill To', 'Კანონპროექტი', 'बिल करा', 'Bil Kepada', 'ਬਿਲ ਕਰੋ', 'பில் டு', 'బిల్ టు', 'Bill till', 'Bill To');
INSERT INTO `languages` VALUES (230, 'paid_amount', 'Paid Amount', 'দেওয়া পরিমাণ', 'المبلغ المدفوع', 'Montant payé', 'भरी गई राशि', 'Jumlah pembayaran', 'Importo pagato', '支払金額', '지불 금액', 'Betaalde hoeveelheid', 'Quantidade paga', 'จำนวนเงินที่ชำระ', 'Ödenen miktar', 'ادا کی گئی رقم', '已付金额', 'Betaalde bedrag', 'Bezahlte Menge', 'Πληρωμένο ποσό', 'Monto de pago', 'भुक्तानी गरिएको रकम', 'Выплаченная сумма', 'Betalt beløb', 'Վճարված գումարը', 'Გადახდილი თანხა', 'देय रक्कम', 'Jumlah bayaran', 'ਭੁਗਤਾਨ ਕੀਤੀ ਰਕਮ', 'செலுத்திய தொகை', 'చెల్లించిన మొత్తం', 'Betalt belopp', 'Bayad na Halaga');
INSERT INTO `languages` VALUES (231, 'due', 'Due', 'দরুন', 'بسبب', 'Dû', 'देय', 'karena', 'Dovuto', '原因', '정당한', 'verschuldigd', 'Devido', 'ครบกำหนด', 'gereken', 'وجہ', '应有', 'weens', 'Fällig', 'Λόγω', 'Debido', 'कारण', 'В связи', 'På grund', 'Պատճառ', 'Გამო', 'देय', 'Kerana', 'ਕਾਰਨ', 'காரணமாக', 'కారణంగా', 'På grund av', 'Dahil');
INSERT INTO `languages` VALUES (232, 'amount_paid', 'Amount Paid', 'পরিমাণ অর্থ প্রদান করা', 'المبلغ المدفوع', 'Le montant payé', 'राशि का भुगतान', 'Jumlah yang dibayarkan', 'Importo pagato', '払込金額', '금액 지급', 'Betaald bedrag', 'Quantia paga', 'จำนวนเงินที่จ่าย', 'Ödenen miktar', 'رقم ادا کر دی', '支付的金额', 'Bedrag betaal', 'Bezahlter Betrag', 'Ποσό που καταβάλλεται', 'Cantidad pagada', 'तिरीएको रकम', 'Оплаченная сумма', 'Betalt beløb', 'Վճարված գումարը', 'Გადახდილი თანხა', 'देय रक्कम', 'Amaun yang dibayar', 'ਭੁਗਤਾਨ ਕੀਤੀ ਰਕਮ', 'பணம் செலுத்தப்பட்டது', 'డబ్బులు చెల్లించబడినవి', 'Betalt belopp', 'Halagang ibinayad');
INSERT INTO `languages` VALUES (233, 'payment_successfull', 'Payment has been successful', 'পেমেন্ট সফল হয়েছে', 'دفع النجاح', 'Paiement Successfull', 'भुगतान सफल', 'Successfull pembayaran', 'Successfull pagamento', '支払成功し', '결제 성공적인', 'betaling Succesvolle', 'Successfull pagamento', 'ที่ประสบความสำเร็จการชำระเงิน', 'Ödeme Başarılı', 'ادائیگی کامیاب', '支付全成', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (234, 'add_invoice/payment', 'Add Invoice/payment', 'ইনভয়েস / পেমেন্ট যোগ', 'إضافة فاتورة / دفع', 'Ajouter Facture / paiement', 'चालान / भुगतान जोड़े', 'Tambahkan Faktur / pembayaran', 'Aggiungere fattura / pagamento', '請求書/支払いを追加', '송장 / 지불 추가', 'Voeg Factuur / betaling', 'Adicionar fatura / pagamento', 'เพิ่มใบแจ้งหนี้ / การชำระเงิน', 'Fatura / ödeme ekle', 'شامل کریں انوائس / ادائیگی', '添加发票/付款', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (235, 'invoices', 'Invoices', 'ইনভয়েস বা চালান', 'الفواتير', 'factures', 'चालान', 'faktur', 'Fatture', '請求書', '송장', 'facturen', 'facturas', 'ใบแจ้งหนี้', 'faturalar', 'انوائس', '发票', 'fakture', 'Rechnungen', 'Τιμολόγια', 'Facturas', 'चलानी', 'Счета-фактуры', 'Fakturaer', 'Հաշիվ-ապրանքագրեր', 'ინვოისები', 'पावत्या', 'Invois', 'ਚਲਾਨ', 'விலைப்பட்டியல்', 'రసీదులు', 'fakturor', 'Mga Invoice');
INSERT INTO `languages` VALUES (236, 'action', 'Action', 'কর্ম', 'عمل', 'action', 'कार्य', 'Tindakan', 'Azione', 'アクション', '동작', 'Actie', 'Açao', 'การกระทำ', 'Aksiyon', 'عمل', '行动', 'aksie', 'Aktion', 'Δράση', 'Acción', 'कार्य', 'действие', 'Handling', 'Գործողություն', 'მოქმედება', 'कृती', 'Tindakan', 'ਐਕਸ਼ਨ', 'செயல்', 'యాక్షన్', 'Verkan', 'Pagkilos');
INSERT INTO `languages` VALUES (237, 'required', 'Required', 'প্রয়োজনীয়', 'مطلوب', 'Obligatoire', 'अपेक्षित', 'Wajib', 'richiesto', '必須', '필수', 'nodig', 'Requeridos', 'จำเป็นต้องใช้', 'gereken', 'مطلوب', '需要', 'vereis', 'Erforderlich', 'Απαιτείται', 'Necesario', 'आवाश्यक', 'необходимые', 'Nødvendig', 'Պահանջվում է', 'საჭირო', 'आवश्यक', 'Dikehendaki', 'ਲੋੜੀਂਦਾ', 'தேவை', 'అవసరం', 'Nödvändig', 'Kailangan');
INSERT INTO `languages` VALUES (238, 'info', 'Info', 'তথ্য', 'معلومات', 'Info', 'जानकारी', 'Info', 'Informazioni', 'インフォ', '정보', 'info', 'informações', 'ข้อมูล', 'Bilgi', 'انفارمیشن', '信息', 'info', 'Die Info', 'Πληροφορίες', 'Informacion', 'जानकारी', 'Информация', 'Info', 'Տեղեկատվություն', 'ინფორმაცია', 'माहिती', 'Maklumat', 'ਜਾਣਕਾਰੀ', 'தகவல்', 'సమాచారం', 'Info', 'Impormasyon');
INSERT INTO `languages` VALUES (239, 'month', 'Month', 'মাস', '\r\nشهر', 'mois', 'महीना', 'bulan', 'mese', '月', '달', 'maand', 'mês', 'เดือน', 'ay', 'مہینہ', '月', 'maand', 'Monat', 'Μήνας', 'Mes', 'महिना', 'Месяц', 'Måned', 'Ամիս', 'თვე', 'महिना', 'Sebulan', 'ਮਹੀਨਾ', 'மாதம்', 'నెల', 'Månad', 'Buwan');
INSERT INTO `languages` VALUES (240, 'details', 'Details', 'বিস্তারিত', 'تفاصيل', 'Détails', 'विवरण', 'rincian', 'Dettagli', '詳細', '세부', 'Details', 'Detalhes', 'รายละเอียด', 'Ayrıntılar', 'تفصیلات دیکھیں', '细节', 'besonderhede', 'Details', 'Λεπτομέριες', 'Detalles', 'विवरण', 'подробности', 'detaljer', 'Մանրամասները', 'დეტალები', 'तपशील', 'Perincian', 'ਵੇਰਵਾ', 'விவரங்கள்', 'వివరాలు', 'detaljer', 'Mga Detalye');
INSERT INTO `languages` VALUES (241, 'new', 'New', 'নতুন', 'الجديد', 'Nouveau', 'नया', 'Baru', 'Nuovo', '新しい', '새로운', 'nieuwe', 'Novo', 'ใหม่', 'Yeni', 'نئی', '新', 'nuwe', 'Neu', 'Νέος', 'Nuevo', 'नयाँ', 'новый', 'Ny', 'Նոր', 'ახალი', 'नवीन', 'Baru', 'ਨਵਾਂ', 'புதியது', 'న్యూ', 'Ny', 'Bago');
INSERT INTO `languages` VALUES (242, 'reply_message', 'Reply Message', 'বার্তা উত্তর', 'رسالة الرد', 'Réponse au message', 'संदेश का जवाब', 'pesan balasan', 'messaggio di risposta', 'メッセージ返信', '메시지 회신', 'berichtantwoord', 'Resposta da mensagem', 'ตอบกลับข้อความ', 'Mesaj cevabı', 'پیغام کا جواب', '消息回复', 'Antwoord boodskap', 'Nachricht beantworten', 'Απάντηση μηνύματος', 'Mensaje de respuesta', 'सन्देशलाई जवाफ दिनुहोस्', 'Ответное сообщение', 'Besvar meddelelse', 'Պատասխան հաղորդագրություն', 'პასუხის გაგზავნა', 'उत्तर द्या संदेश', 'Balas Mesej', 'ਜਵਾਬ ਸੁਨੇਹਾ', 'பதில் செய்தி', 'ప్రత్యుత్తరం సందేశం', 'Svara meddelande', 'Sagot ng Mensahe');
INSERT INTO `languages` VALUES (243, 'message_sent', 'Message Sent', 'বার্তা পাঠানো', 'تم الارسال', '', 'मैसेज बेजा गया', 'Pesan terkirim', 'Messaggio inviato', 'メッセージが送信されました', '메시지 전송 됨', 'Bericht verzonden', 'Mensagem enviada', 'ส่งข้อความ', 'Mesajı gönderildi', 'پیغام چلا گیا', '留言已发送', 'Boodskap gestuur', 'Nachricht gesendet', 'Το μήνυμα στάλθηκε', 'Mensaje enviado', 'सन्देश पठाइयो', 'Сообщение отправлено', 'Besked sendt', 'Նամակը ուղարկված է', 'Შეტყობინება გაგზავნილია', 'संदेश पाठवला', 'Pesanan dihantar', 'ਸੁਨੇਹਾ ਭੇਜਿਆ', 'செய்தி அனுப்பப்பட்டது', 'సందేశం పంపబడింది', 'Meddelande skickat', 'Ipinadala ang Mensahe');
INSERT INTO `languages` VALUES (244, 'search', 'Search', 'অনুসন্ধান', 'بحث', 'chercher', 'खोज', 'pencarian', 'ricerca', 'サーチ', '수색', 'zoeken', 'pesquisa', 'ค้นหา', 'arama', 'کی تلاش', '搜索', 'Soek', 'Suche', 'Αναζήτηση', 'Buscar', 'खोज्नुहोस्', 'Поиск', 'Søg', 'Որոնել', 'ძებნა', 'शोधा', 'Cari', 'ਖੋਜ', 'தேடல்', 'వెతకండి', 'Sök', 'Paghahanap');
INSERT INTO `languages` VALUES (245, 'religion', 'Religion', 'ধর্ম', 'دين', 'Religion', 'धर्म', 'Agama', 'Religione', '宗教', '종교', 'Godsdienst', 'Religião', 'ศาสนา', 'Din', 'مذہب', '宗教', 'Geloof', 'Religion', 'Θρησκεία', 'Religión', 'धर्म', 'религия', 'Religion', 'Կրոն', 'რელიგია', 'धर्म', 'Agama', 'ਧਰਮ', 'மதம்', 'మతం', 'Religion', 'Relihiyon');
INSERT INTO `languages` VALUES (246, 'blood_group', 'Blood group', 'রক্তের গ্রুপ', 'فصيلة الدم', 'groupe sanguin', 'रक्त समूह', 'golongan darah', 'gruppo sanguigno', '血液型', '혈액형', 'bloedgroep', 'grupo sanguíneo', 'กรุ๊ปเลือด', 'kan grubu', 'خون کے گروپ', '血型', 'Bloedgroep', 'Blutgruppe', 'Ομάδα αίματος', 'Grupo sanguíneo', 'रक्त समूह', 'Группа крови', 'Blodgruppe', 'Արյան խումբ', 'Სისხლის ჯგუფი', 'रक्त गट', 'Kumpulan darah', 'ਬਲੱਡ ਗਰੁੱਪ', 'இரத்த வகை', 'రక్తపు గ్రూపు', 'Blodgrupp', 'Pangkat ng dugo');
INSERT INTO `languages` VALUES (247, 'database_backup', 'Database Backup', 'ডাটাবেজ ব্যাকআপ', 'قاعدة بيانات النسخ الاحتياطي', 'Sauvegarde de base de données', 'डाटाबेस बैकअप', 'database Backup', 'Database Backup', 'データベースバックアップ', '데이터베이스 백업', 'Database Backup', 'Backup de banco de dados', 'การสำรองฐานข้อมูล', 'Veritabanı Yedekleme', 'ڈیٹا بیس بیک اپ', '数据库备份', 'Databasis-rugsteun', 'Datenbanksicherung', 'Δημιουργία αντιγράφων ασφαλείας βάσης δεδομένων', 'Copia de seguridad de la base de datos', 'डाटाबेस बैकअप', 'Резервное копирование базы данных', 'Database backup', 'Տվյալների բազայի կրկնօրինակում', 'მონაცემთა ბაზის სარეზერვო საშუალება', 'डेटाबेस बॅकअप', 'Sandaran Pangkalan Data', 'ਡਾਟਾਬੇਸ ਬੈਕਅਪ', 'தரவுத்தள காப்புப்பிரதி', 'డేటాబేస్ బ్యాకప్', 'Databasbackup', 'Pag-backup ng Database');
INSERT INTO `languages` VALUES (248, 'search', 'Search', 'অনুসন্ধান', 'بحث', 'chercher', 'खोज', 'pencarian', 'ricerca', 'サーチ', '수색', 'zoeken', 'pesquisa', 'ค้นหา', 'arama', 'کی تلاش', '搜索', 'Soek', 'Suche', 'Αναζήτηση', 'Buscar', 'खोज्नुहोस्', 'Поиск', 'Søg', 'Որոնել', 'ძებნა', 'शोधा', 'Cari', 'ਖੋਜ', 'தேடல்', 'వెతకండి', 'Sök', 'Paghahanap');
INSERT INTO `languages` VALUES (249, 'payments_history', 'Fees Pay / Invoice', 'ফি পরিশোধ / চালান', 'رسوم الدفع / الفاتورة', 'honoraires payer / facture', 'फीस का भुगतान / चालान', 'biaya bayar / faktur', 'tasse di pagamento / fattura', '手数料/請求書', '수수료 지불 / 송장', 'honoraria betalen / facturen', 'taxas de pagamento / fatura', 'ค่าธรรมเนียมการชำระเงิน / ใบแจ้งหนี้', 'ücret ödemesi / fatura', 'فیس ادا / انوائس', '收费/发票', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (250, 'message_restore', 'Message Restore', 'বার্তা পুনরুদ্ধার', 'استعادة الرسائل', 'Restauration de message', 'संदेश पुनर्स्थापना', 'Pesan dikembalikan', 'Messaggio di ripristino', 'メッセージの復元', '메시지 복원', 'bericht herstellen', 'Restaurar mensagem', 'กู้คืนข้อความ', 'Mesajın geri yüklenmesi', 'پیغام بحال', '留言恢复', 'Fooie betaal / faktuur', 'Gebühren bezahlen / Rechnung', 'Πληρωμή / Τιμολόγιο', 'Tasas de pago / factura', 'शुल्क भुक्तानी / इनभ्वाइस', 'Тарифы Оплата / Счет', 'Gebyrer / faktura', 'Վճարներ / հաշիվ ապրանքագիր', 'საფასურის გადახდა / ინვოისი', 'फी वेतन / बीजक', 'Bayaran Yuran / Invois', 'ਫੀਸ ਦਾ ਭੁਗਤਾਨ / ਇਨਵੌਇਸ', 'கட்டணம் செலுத்துதல் / விலைப்பட்டியல்', 'ఫీజు చెల్లింపు / ఇన్వాయిస్', 'Avgifter betala / faktura', 'Bayad na Bayad / Invoice');
INSERT INTO `languages` VALUES (251, 'write_new_message', 'Write New Message', 'নতুন বার্তা লিখতে', 'إرسال رسالة جديدة', 'Ecrire un nouveau message', 'नया संदेश लिखें', 'Tulis baru Pesan', 'Scrivi nuovo messaggio', '新しいメッセージを書きます', '새 메시지 쓰기', 'Schrijf New Message', 'Escrever Nova Mensagem', 'เขียนข้อความใหม่', 'Yeni Mesaj Yaz', 'نیا پیغام لکھیں', '我要留言', 'Skryf \'n nuwe boodskap', 'Neue Nachricht schreiben', 'Γράψτε νέο μήνυμα', 'Escribir nuevo mensaje', 'नयाँ सन्देश लेख्नुहोस्', 'Написать новое сообщение', 'Skriv ny besked', 'Գրեք նոր հաղորդագրություն', 'დაწერეთ ახალი შეტყობინება', 'नवीन संदेश लिहा', 'Tulis Mesej Baru', 'ਨਵਾਂ ਸੁਨੇਹਾ ਲਿਖੋ', 'புதிய செய்தியை எழுதுங்கள்', 'క్రొత్త సందేశం రాయండి', 'Skriv nytt meddelande', 'Sumulat ng Bagong Mensahe');
INSERT INTO `languages` VALUES (252, 'attendance_sheet', 'Attendance Sheet', 'এ্যাটেনডেন্স শীট', 'ورقة الحضور', 'Feuille de présence', 'उपस्थिति पत्रक', 'Absensi', 'Foglio presenze', '出席シート', '출석 시트', 'Presentielijst', 'Folha de Atendimento', 'แผ่นการเข้าร่วม', 'Yoklama kağıdı', 'حاضری شیٹ', '考勤表', 'Bywoningsblad', 'Anwesenheitsliste', 'Φύλλο παρακολούθησης', 'Hoja de asistencia', 'उपस्थिति पाना', 'Посещаемости лист', 'Deltagelsesark', 'Ներկայացման թերթ', 'დასწრების ფურცელი', 'हजेरी पत्रक', 'Helaian Kehadiran', 'ਹਾਜ਼ਰੀ ਸ਼ੀਟ', 'வருகை தாள்', 'హాజరు షీట్', 'Närvarolista', 'Papel ng pagdalo');
INSERT INTO `languages` VALUES (253, 'holiday', 'Holiday', 'ছুটির দিন', 'يوم الاجازة', 'Vacances', 'छुट्टी का दिन', 'Liburan', 'Vacanza', '休日', '휴일', 'Vakantie', 'Feriado', 'วันหยุด', 'Tatil', 'چھٹیوں کا', '假日', 'Vakansie', 'Urlaub', 'Αργία', 'Fiesta', 'छुट्टी', 'Праздничный день', 'Ferie', 'Արձակուրդ', 'დღესასწაული', 'सुट्टी', 'Percutian', 'ਛੁੱਟੀ', 'விடுமுறை', 'హాలిడే', 'Semester', 'Holiday');
INSERT INTO `languages` VALUES (254, 'exam', 'Exam', 'পরীক্ষা', 'امتحان', 'Examen', 'परीक्षा', 'Ujian', 'Esame', '試験', '시험', 'Examen', 'Exame', 'การสอบ', 'Sınav', 'امتحان', '考试', 'eksamen', 'Prüfung', 'Εξέταση', 'Examen', 'परीक्षा', 'Экзамен', 'Eksamen', 'Քննություն', 'გამოცდა', 'परीक्षा', 'Peperiksaan', 'ਪ੍ਰੀਖਿਆ', 'தேர்வு', 'పరీక్షా', 'Examen', 'Exam');
INSERT INTO `languages` VALUES (255, 'successfully', 'Successfully', 'সফলভাবে', 'بنجاح', 'Avec succès', 'सफलतापूर्वक', 'Berhasil', 'Con successo', '成功', '성공적으로', 'Met succes', 'Com sucesso', 'ประสบความสำเร็จ', 'Başarıyla', 'کامیابی سے', '成功了', 'suksesvol', 'Erfolgreich', 'Επιτυχώς', 'Exitosamente', 'सफलतापूर्वक', 'Успешно', 'Succesfuldt', 'Հաջողությամբ', 'Წარმატებით', 'यशस्वीरित्या', 'Berjaya', 'ਸਫਲਤਾ ਨਾਲ', 'வெற்றிகரமாக', 'విజయవంతంగా', 'Framgångsrikt', 'Matagumpay');
INSERT INTO `languages` VALUES (256, 'admin', 'Admin', 'অ্যাডমিন', 'مشرف', 'Admin', 'व्यवस्थापक', 'Admin', 'Admin', '管理者', '관리자', 'beheerder', 'Admin', 'ผู้ดูแลระบบ', 'Admin', 'ایڈمن', '管理员', 'admin', 'Administrator', 'διαχειριστής', 'Administración', 'प्रशासन', 'Администратор', 'Admin', 'Ադմինիստրատոր', 'ადმინ', 'प्रशासन', 'Pentadbir', 'ਐਡਮਿਨ', 'நிர்வாகம்', 'అడ్మిన్', 'Administration', 'Admin');
INSERT INTO `languages` VALUES (257, 'inbox', 'Inbox', 'ইনবক্স', 'صندوق الوارد', 'Boîte de réception', 'इनबॉक्स', 'Kotak masuk', 'Posta in arrivo', '受信トレイ', '받은 편지함', 'Inbox', 'Caixa de entrada', 'กล่องจดหมาย', 'Gelen kutusu', 'ان باکس', '收件箱', 'posbus', 'Posteingang', 'Inbox', 'Bandeja de entrada', 'इनबक्स', 'входящие', 'Indbakke', 'Ներարկղ', 'Შემომავალი', 'इनबॉक्स', 'Peti Masuk', 'ਇਨਬਾਕਸ', 'உட்பெட்டி', 'ఇన్బాక్స్', 'Inkorg', 'Inbox');
INSERT INTO `languages` VALUES (258, 'sent', 'Sent', 'প্রেরিত', 'أرسلت', 'Envoyé', 'भेज दिया', 'Dikirim', 'Inviato', '送信済み', '전송 됨', 'Verzonden', 'Enviei', 'ส่งแล้ว', 'Gönderildi', 'مرسلہ', '发了', 'gestuur', 'Geschickt', 'Απεσταλμένα', 'Expedido', 'पठाइयो', 'Отправлено', 'Sendt', 'Ուղարկվել է', 'Გაგზავნილი', 'पाठविला', 'Dihantar', 'ਭੇਜਿਆ', 'அனுப்பப்பட்டது', 'పంపిన', 'sände', 'Ipinadala');
INSERT INTO `languages` VALUES (259, 'important', 'Important', 'গুরুত্বপূর্ণ', 'مهم', 'Important', 'जरूरी', 'Penting', 'Importante', '重要', '중대한', 'Belangrijk', 'Importante', 'สำคัญ', 'Önemli', 'اہم', '重要', 'Belangrik', 'Wichtig', 'Σπουδαίος', 'Importante', 'महत्वपूर्ण', 'Важный', 'Vigtig', 'Կարևոր է', 'Მნიშვნელოვანი', 'महत्वाचे', 'Penting', 'ਮਹੱਤਵਪੂਰਨ', 'முக்கியமான', 'ముఖ్యమైన', 'Viktig', 'Mahalaga');
INSERT INTO `languages` VALUES (260, 'trash', 'Trash', 'আবর্জনা', 'قمامة، يدمر، يهدم', 'Poubelle', 'कचरा', 'Sampah', 'Spazzatura', 'ごみ', '폐물', 'Prullenbak', 'Lixo', 'ถังขยะ', 'Çöp', 'ردی کی ٹوکری', '垃圾', 'asblik', 'Müll', 'Σκουπίδια', 'Basura', 'रद्दी टोकरी', 'дрянь', 'Affald', 'Աղբարկղ', 'ნაგავი', 'कचरा', 'Sampah', 'ਰੱਦੀ', 'குப்பை', 'ట్రాష్', 'Skräp', 'Basura');
INSERT INTO `languages` VALUES (261, 'error', 'Unsuccessful', 'ব্যার্থ', 'غير ناجحة', 'Infructueux', 'असफल', 'Gagal', 'Senza esito', '失敗', '실패', 'Mislukt', 'Mal sucedido', 'ไม่สำเร็จ', 'Başarısız', 'ناکام', '不成功', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (262, 'sessions_list', 'Sessions List', 'সেশন তালিকা', 'قائمة الجلسات', 'Liste des sessions', 'सत्र सूची', 'Daftar Sesi', 'Elenco Sessioni', 'セッションリスト', '세션 목록', 'Sessieslijst', 'Lista de Sessões', 'รายการเซสชั่น', 'Oturumlar Listesi', 'سیشن کی فہرست', '会议列表', 'Sessieslys', 'Sitzungsliste', 'Λίστα συνεδριών', 'Lista de sesiones', 'सत्र सूची', 'Список сессий', 'Sessioner liste', 'Նիստերի ցուցակ', 'სესიების სია', 'सत्रांची यादी', 'Senarai Sesi', 'ਸੈਸ਼ਨ ਸੂਚੀ', 'அமர்வுகள் பட்டியல்', 'సెషన్ల జాబితా', 'Sessionions List', 'Listahan ng Session');
INSERT INTO `languages` VALUES (263, 'session_settings', 'Session Settings', 'সেশন সেটিংস', 'إعدادات الجلسة', 'Paramètres de la session', 'सत्र सेटिंग', 'Pengaturan Sesi', 'Impostazioni sessione', 'セッション設定', '세션 설정', 'Sessie instellingen', 'Configurações da Sessão', 'การตั้งค่าเซสชัน', 'Oturum Ayarları', 'سیشن ترتیبات', '会话设置', 'Sessie-instellings', 'Sitzungseinstellungen', 'Ρυθμίσεις περιόδου σύνδεσης', 'Configuraciones de sesión', 'सत्र सेटिंग्स', 'Настройки сеанса', 'Sessionindstillinger', 'Նիստի կարգավորումները', 'სესიის პარამეტრები', 'सत्र सेटिंग्ज', 'Tetapan Sesi', 'ਸ਼ੈਸ਼ਨ ਸੈਟਿੰਗਜ਼', 'அமர்வு அமைப்புகள்', 'సెషన్ సెట్టింగులు', 'Sessioninställningar', 'Mga Setting ng Session');
INSERT INTO `languages` VALUES (264, 'add_designation', 'Add Designation', 'পদবী যোগ করুন', 'إضافة تسمية', 'Ajouter une désignation', 'पदनाम जोड़ें', 'Tambahkan Penunjukan', 'Aggiungi designazione', '指定を追加する', '지정 추가', 'Aanwijzing toevoegen', 'Adicionar Designação', 'เพิ่มการกำหนด', 'İsmi Ekle', 'عہدہ شامل کریں', '添加名称', 'Voeg aanwysing by', 'Bezeichnung hinzufügen', 'Προσθήκη ονομασίας', 'Agregar designación', 'पद थप्नुहोस्', 'Добавить обозначение', 'Tilføj betegnelse', 'Ավելացնել նշանակումը', 'დაამატეთ აღნიშვნა', 'पदनाम जोडा', 'Tambah Penetapan', 'ਅਹੁਦਾ ਸ਼ਾਮਲ ਕਰੋ', 'பதவி சேர்க்கவும்', 'హోదా జోడించండి', 'Lägg till beteckning', 'Magdagdag ng Pagtatalaga');
INSERT INTO `languages` VALUES (265, 'users', 'Users', 'ব্যবহারকারীরা', 'المستخدمين', 'Utilisateurs', 'उपयोगकर्ता', 'Pengguna', 'utenti', 'ユーザー', '사용자', 'gebruikers', 'Comercial', 'ผู้ใช้', 'Kullanıcılar', 'صارفین', '用户', 'gebruikers', 'Benutzer', 'Χρήστες', 'Los usuarios', 'प्रयोगकर्ताहरू', 'пользователей', 'Brugere', 'Օգտագործողներ', 'მომხმარებლები', 'वापरकर्ते', 'Pengguna', 'ਉਪਭੋਗਤਾ', 'பயனர்கள்', 'వినియోగదారులు', 'användare', 'Mga gumagamit');
INSERT INTO `languages` VALUES (266, 'librarian', 'Librarian', 'গ্রন্থাগারিক', 'أمين المكتبة', 'Bibliothécaire', 'पुस्तकालय अध्यक्ष', 'Pustakawan', 'Bibliotecario', '図書館員', '사서', 'Bibliothecaris', 'Bibliotecário', 'บรรณารักษ์', 'kütüphaneci', 'لائبریرین', '图书管理员', 'bibliotekaris', 'Bibliothekar', 'Βιβλιοθηκάριος', 'bibliotecario', 'लाइब्रेरियन', 'библиотекарь', 'Bibliotekar', 'Գրադարանավար', 'Ბიბლიოთეკარი', 'ग्रंथपाल', 'Pustakawan', 'ਲਾਇਬ੍ਰੇਰੀਅਨ', 'நூலகர்', 'లైబ్రేరియన్', 'Bibliotekarie', 'Librarian');
INSERT INTO `languages` VALUES (267, 'accountant', 'Accountant', 'হিসাবরক্ষক', 'محاسب', 'Comptable', 'मुनीम', 'Akuntan', 'Contabile', '会計士', '회계사', 'Accountant', 'Contador', 'นักบัญชี', 'Muhasebeci', 'اکاؤنٹنٹ', '会计', 'rekenmeester', 'Buchhalter', 'Λογιστής', 'Contador', 'लेखापाल', 'бухгалтер', 'Revisor', 'Հաշվապահ', 'ბუღალტერი', 'लेखापाल', 'Akauntan', 'ਲੇਖਾਕਾਰ', 'கணக்காளர்', 'అకౌంటెంట్', 'Revisor', 'Accountant');
INSERT INTO `languages` VALUES (268, 'academics', 'Academics', 'বিদ্যালয় সংক্রান্ত', 'مؤسسيا', 'institutionnellement', 'संस्थागत', 'secara institusional', 'istituzionalmente', '制度的に', '제도적으로', 'institutioneel', 'institucionalmente', 'institutionally', 'kurumsal olarak', 'ادارہ', '体制', 'akademici', 'Akademiker', 'Ακαδημαϊκοί', 'Académica', 'शिक्षाविद्', 'Академики', 'akademikere', 'Գիտնականներ', 'აკადემიკოსები', 'शैक्षणिक', 'Akademik', 'ਵਿਦਿਅਕ', 'கல்வியாளர்கள்', 'విద్యావేత్తలు', 'akademiker', 'Akademikong');
INSERT INTO `languages` VALUES (269, 'employees_attendance', 'Employees Attendance', 'কর্মচারী উপস্থিতি', 'حضور الموظفين', 'Participation des employés', 'कर्मचारी उपस्थिति', 'Kehadiran karyawan', 'La presenza dei dipendenti', '従業員の出席', '직원 출석', 'Medewerkers aanwezigheid', 'Atendimento dos funcionários', 'การเข้าร่วมงานของพนักงาน', 'Çalışanlara katılım', 'ملازمین کی حاضری', '员工出勤', 'Bywoning van werknemers', 'Anwesenheit der Mitarbeiter', 'Συμμετοχή εργαζομένων', 'Asistencia de empleados', 'कर्मचारी उपस्थिति', 'Посещаемость сотрудников', 'Deltagelse i medarbejdere', 'Աշխատակիցների հաճախում', 'თანამშრომლების დასწრება', 'कर्मचार्‍यांची उपस्थिती', 'Kehadiran Pekerja', 'ਕਰਮਚਾਰੀ ਹਾਜ਼ਰੀ', 'பணியாளர்கள் வருகை', 'ఉద్యోగుల హాజరు', 'Anställdas närvaro', 'Pagdalo ng mga empleyado');
INSERT INTO `languages` VALUES (270, 'set_exam_term', 'Set Exam Term', 'টার্ম সেট করুন', 'تعيين مدة الامتحان', 'Terminer l\'examen', 'परीक्षा अवधि सेट करें', 'Tetapkan Ujian Term', 'Imposta il termine dell\'esame', '試験期間を設定する', '시험 기간 설정', 'Stel examentermijn in', 'Definir Termo de Exame', 'กำหนดระยะเวลาการสอบ', 'Sınav Süresini Ayarlayın', 'امتحان کی مدت مقرر کریں', '设置考试期限', 'Stel eksamentermyn in', 'Prüfungsdauer festlegen', 'Ορίστε όρο εξετάσεων', 'Establecer plazo de examen', 'परीक्षा अवधि सेट गर्नुहोस्', 'Установить срок экзамена', 'Indstil eksamensperiode', 'Սահմանել քննության ժամկետը', 'დაადგინეთ გამოცდის ვადა', 'परीक्षेची मुदत सेट करा', 'Tetapkan Tempoh Peperiksaan', 'ਪ੍ਰੀਖਿਆ ਦੀ ਮਿਆਦ ਨਿਰਧਾਰਤ ਕਰੋ', 'தேர்வு காலத்தை அமைக்கவும்', 'పరీక్షా వ్యవధిని సెట్ చేయండి', 'Ställ in tentamen', 'Itakda ang Kataga ng Exam');
INSERT INTO `languages` VALUES (271, 'set_attendance', 'Set Attendance', 'উপস্থিতি সেট করুন', 'تعيين الحضور', 'Assurer la fréquentation', 'उपस्थिति सेट करें', 'Tetapkan Kehadiran', 'Impostare la frequenza', '出席を設定する', '출석 설정', 'Set Attendance', 'Definir atendimento', 'ตั้งผู้เข้าร่วม', 'Katılımı ayarla', 'حاضری مقرر کریں', '设置考勤', 'Stel bywoning', 'Anwesenheit einstellen', 'Ορίστε την παρακολούθηση', 'Establecer asistencia', 'उपस्थिति सेट गर्नुहोस्', 'Установить посещаемость', 'Indstil deltagelse', 'Ներկայացրեք մասնակցությունը', 'დასწრება', 'उपस्थिती निश्चित करा', 'Tetapkan Kehadiran', 'ਹਾਜ਼ਰੀ ਨਿਰਧਾਰਤ ਕਰੋ', 'வருகையை அமைக்கவும்', 'హాజరును సెట్ చేయండి', 'Ställ upp närvaro', 'Itakda ang Pagdalo');
INSERT INTO `languages` VALUES (272, 'marks', 'Marks', 'মার্কস', 'علامات', 'Des notes', 'निशान', 'Tanda', 'votazione', 'マーク', '점수', 'Marks', 'Marcas', 'เครื่องหมาย', 'izler', 'نشانات', '分数', 'punte', 'Markierungen', 'Σημάδια', 'Marcas', 'अंक', 'Метки', 'Marks', 'Նշում է', 'ნიშნები', 'गुण', 'Tanda', 'ਨਿਸ਼ਾਨ', 'மதிப்பெண்கள்', 'మార్క్స్', 'Marks', 'Mga Marks');
INSERT INTO `languages` VALUES (273, 'books_category', 'Books Category', 'বই বিভাগ', 'فئة الكتاب', 'Catégorie de livres', 'पुस्तक श्रेणी', 'Kategori buku', 'Categoria di libri', 'ブックカテゴリ', '도서 카테고리', 'Boek categorie', 'Categoria de livro', 'หมวดหนังสือ', 'Kitap Kategorisi', 'کتاب کی قسم', '书类', 'Boeke-kategorie', 'Buchkategorie', 'Κατηγορία βιβλίων', 'Categoría de libros', 'पुस्तक कोटि', 'Категория книг', 'Bøger kategori', 'Գրքերի կատեգորիա', 'წიგნების კატეგორია', 'पुस्तके श्रेणी', 'Kategori Buku', 'ਕਿਤਾਬਾਂ ਦੀ ਸ਼੍ਰੇਣੀ', 'புத்தகங்கள் வகை', 'పుస్తకాల వర్గం', 'Böcker kategori', 'Mga kategorya ng Mga Libro');
INSERT INTO `languages` VALUES (274, 'transport', 'Transport', 'পরিবহন', 'المواصلات', 'Transport', 'ट्रांसपोर्ट', 'Mengangkut', 'Trasporto', '輸送', '수송', 'Vervoer', 'Transporte', 'ขนส่ง', 'taşıma', 'نقل و حمل', '运输', 'vervoer', 'Transport', 'Μεταφορά', 'Transporte', 'यातायात', 'Transport', 'Transportere', 'Տրանսպորտ', 'ტრანსპორტი', 'वाहतूक', 'Pengangkutan', 'ਆਵਾਜਾਈ', 'போக்குவரத்து', 'రవాణా', 'Transport', 'Transport');
INSERT INTO `languages` VALUES (275, 'fees', 'Fees', 'ফি', 'رسوم', 'honoraires', 'फीस', 'Biaya', 'tasse', '手数料', '수수료', 'fees', 'honorários', 'ค่าธรรมเนียม', 'harç', 'فیس', '费用', 'fooie', 'Gebühren', 'Αμοιβές', 'Tarifa', 'शुल्क', 'сборы', 'Gebyrer', 'Վճարներ', 'საფასური', 'शुल्क', 'Bayaran', 'ਫੀਸ', 'கட்டணம்', 'ఫీజు', 'avgifter', 'Bayarin');
INSERT INTO `languages` VALUES (276, 'fees_allocation', 'Fees Allocation', 'ফি বরাদ্দকরণ', 'توزيع الرسوم', 'répartition des frais', 'शुल्क आवंटन', 'alokasi biaya', 'assegnazione dei diritti', '手数料の割り当て', '수수료 할당', 'verdeling van de vergoedingen', 'alocação de tarifas', 'การจัดสรรค่าธรรมเนียม', 'ücret tahsisi', 'فیس مختص', '费用分配', 'Toekenning van gelde', 'Gebührenverteilung', 'Κατανομή τελών', 'Asignación de tarifas', 'शुल्क छुट', 'Распределение сборов', 'Gebyrer tildeling', 'Վճարների տեղաբաշխում', 'გადასახადების განაწილება', 'शुल्क वाटप', 'Peruntukan Yuran', 'ਫੀਸਾਂ ਦੀ ਅਲਾਟਮੈਂਟ', 'கட்டணம் ஒதுக்கீடு', 'ఫీజుల కేటాయింపు', 'Avgiftsfördelning', 'Alokasyon sa Bayad');
INSERT INTO `languages` VALUES (277, 'fee_category', 'Fee Category', 'ফি বিভাগ', 'فئة الرسوم', 'Catégorie tarifaire', 'शुल्क श्रेणी', 'Kategori biaya', 'Categoria di tassa', '手数料カテゴリ', '수수료 카테고리', 'Tariefcategorie', 'Categoria de taxa', 'ประเภทค่าธรรมเนียม', 'Ücret kategorisi', 'فیس کی قسم', '费用类别', 'Fooi-kategorie', 'Gebührenkategorie', 'Κατηγορία χρεώσεων', 'Categoría de tarifa', 'शुल्क श्रेणी', 'Плата Категория', 'Gebyrkategori', 'Վճարների կատեգորիա', 'საფასურის კატეგორია', 'फी श्रेणी', 'Kategori Yuran', 'ਫੀਸ ਸ਼੍ਰੇਣੀ', 'கட்டணம் வகை', 'ఫీజు వర్గం', 'Avgiftskategori', 'Uri ng Bayad');
INSERT INTO `languages` VALUES (278, 'report', 'Report', 'প্রতিবেদন', 'أبلغ عن', 'rapport', 'रिपोर्ट', 'melaporkan', 'rapporto', '報告する', '보고서', 'rapport', 'relatório', 'รายงาน', 'rapor', 'رپورٹ', '报告', 'verslag', 'Bericht', 'Κανω ΑΝΑΦΟΡΑ', 'Reporte', 'रिपोर्ट', 'отчет', 'Rapport', 'Հաղորդել', 'მოხსენება', 'अहवाल द्या', 'Lapor', 'ਰਿਪੋਰਟ', 'அறிக்கை', 'నివేదిక', 'Rapportera', 'Mag-ulat');
INSERT INTO `languages` VALUES (279, 'employee', 'Employee', 'কর্মচারী', 'الموظفين', 'employés', 'कर्मचारियों', 'para karyawan', 'dipendenti', '従業員', '직원', 'werknemers', 'Funcionários', 'พนักงาน', 'çalışanlar', 'ملازمین', 'ملازمین', 'werknemer', 'Mitarbeiter', 'Υπάλληλος', 'Empleado', 'कर्मचारी', 'Работник', 'medarbejder', 'Աշխատող', 'თანამშრომელი', 'कर्मचारी', 'Pekerja', 'ਕਰਮਚਾਰੀ', 'ஊழியர்', 'ఉద్యోగి', 'Anställd', 'Empleado');
INSERT INTO `languages` VALUES (280, 'invoice', 'Invoice', 'চালান', 'فاتورة', 'facture d\'achat', 'बीजक', 'faktur', 'fattura', '請求書', '송장', 'factuur', 'fatura', 'ใบแจ้งหนี้', 'fatura', 'انوائس', '发票', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (281, 'event_catalogue', 'Event Catalogue', 'ইভেন্ট ক্যাটালগ', 'كتالوج الأحداث', 'Catalogue des événements', 'इवेंट कैटलॉग', 'Katalog acara', 'Catalogo eventi', 'イベントカタログ', '이벤트 카탈로그', 'Event Catalogus', 'Catálogo de Eventos', 'แค็ตตาล็อกกิจกรรม', 'Etkinlik Kataloğu', 'واقعہ کی فہرست', '活动目录', 'Gebeurtenis katalogus', 'Veranstaltungskatalog', 'Κατάλογος εκδηλώσεων', 'Catálogo de eventos', 'कार्यक्रम क्याटलग', 'Каталог событий', 'Begivenhedskatalog', 'Իրադարձությունների կատալոգ', 'ღონისძიების კატალოგი', 'कार्यक्रम कॅटलॉग', 'Katalog Acara', 'ਇਵੈਂਟ ਕੈਟਾਲਾਗ', 'நிகழ்வு பட்டியல்', 'ఈవెంట్ కాటలాగ్', 'Eventkatalog', 'Catalog ng Kaganapan');
INSERT INTO `languages` VALUES (282, 'total_paid', 'Total Paid', 'মোট দেওয়া', 'مجموع المبالغ المدفوعة', 'Total payé', 'कुल भुगतान हो गया', 'Total Dibayar', 'Totale pagato', '支払総額', '총 지불액', 'Totaal betaald', 'Total pago', 'ทั้งหมดที่จ่าย', 'Toplam Ücretli', 'کل ادا شدہ', '总支付', 'Totale betaal', 'Ganz bezahlt', 'Σύνολο πληρωμένων', 'Total pagado', 'कुल सशुल्क', 'Итого', 'I alt betalt', 'Ընդհանուր վճարված', 'სულ გადახდილი', 'एकूण सशुल्क', 'Jumlah bayaran', 'ਕੁੱਲ ਭੁਗਤਾਨ', 'மொத்தம் செலுத்தியது', 'మొత్తం చెల్లించబడింది', 'Totala belopp som betalats', 'Kabuuang Bayad');
INSERT INTO `languages` VALUES (283, 'total_due', 'Total Due', 'মোট বাকি', 'الاجمالي المستحق', 'Total dû', 'कुल देय', 'Total Jatuh Tempo', 'Totale dovuto', '総額', '총 만기일', 'Totaal verschuldigd', 'Total Due', 'รวมครบกำหนด', 'Toplam Vade', 'کل کی وجہ سے', '总到期', 'Totale betaal', 'Ganz bezahlt', 'Σύνολο πληρωμένων', 'Total pagado', 'कुल सशुल्क', 'Итого', 'I alt betalt', 'Ընդհանուր վճարված', 'სულ გადახდილი', 'एकूण सशुल्क', 'Jumlah bayaran', 'ਕੁੱਲ ਭੁਗਤਾਨ', 'மொத்தம் செலுத்தியது', 'మొత్తం చెల్లించబడింది', 'Totala belopp som betalats', 'Kabuuang Bayad');
INSERT INTO `languages` VALUES (284, 'fees_collect', 'Fees Collect', 'ফি সংগ্রহ', 'تحصيل الرسوم', 'Frais collectés', 'फीस जमा करें', 'Biaya mengumpulkan', 'Le tasse si raccolgono', '手数料徴収', '수수료 징수', 'Vergoedingen verzamelen', 'Taxas cobradas', 'เก็บค่าธรรมเนียม', 'Ücret toplama', 'فیس جمع', '收费', 'Fooie versamel', 'Gebühren sammeln', 'Συλλογή τελών', 'Tasas por cobrar', 'शुल्क स .्कलन', 'Сборы', 'Gebyrer indsamles', 'Վճարները հավաքում', 'მოსაკრებლების შეგროვება', 'शुल्क गोळा', 'Bayaran dikumpulkan', 'ਫੀਸ ਇਕੱਠੀ', 'கட்டணம் வசூலிக்கவும்', 'ఫీజు వసూలు', 'Avgifter Samla', 'Mga Kolektahin');
...
INSERT INTO `languages` VALUES (302, 'discount', 'Discount', 'ডিসকাউন্ট', 'خصم', 'remise', 'छूट', 'diskon', 'sconto', 'ディスカウント', '할인', 'korting', 'desconto', 'ส่วนลด', 'indirim', 'ڈسکاؤنٹ', '折扣', 'afslag', 'Rabatt', 'Εκπτωση', 'Descuento', 'छुट', 'скидка', 'Rabat', 'Զեղչ', 'ფასდაკლებით', 'सवलत', 'Diskaun', 'ਛੂਟ', 'தள்ளுபடி', 'డిస్కౌంట్', 'Rabatt', 'Diskwento');
...
INSERT INTO `languages` VALUES (642, 'account_group', 'Account Group', 'অ্যাকাউন্ট গ্রুপ', 'جماعة حساب', 'Compte de groupe', 'खाता समूह', 'Grup Akun', 'Gruppo di account', 'アカウントグループ', '계정 그룹', 'Accountgroep', 'Accountgroep', 'กลุ่มบัญชี', 'Hesap grubu', 'اکاؤنٹ گروپ', '帐户组', 'Rekeninggroep', 'Kontengruppe', 'Ομάδα λογαριασμού', 'Grupo de cuentas', 'खाता समूह', 'Группа счетов', 'Kontogruppe', 'Հաշվի խումբ', 'ანგარიშის ჯგუფი', 'खाते गट', 'Kumpulan Akaun', 'ਖਾਤਾ ਸਮੂਹ', 'கணக்கு குழு', 'ఖాతా సమూహం', 'Kontogrupp', 'Grupo ng Account');
INSERT INTO `languages` VALUES (643, 'account_group_list', 'Account Group List', 'অ্যাকাউন্ট গ্রুপ তালিকা', 'قائمة مجموعة الحساب', 'Liste des groupes de comptes', 'खाता समूह सूची', 'Daftar Grup Akun', 'Elenco dei gruppi di account', 'アカウントグループリスト', '계정 그룹 목록', 'Lijst met accountgroepen', 'Lista de grupos de contas', 'รายชื่อกลุ่มบัญชี', 'Hesap Grubu Listesi', 'اکاؤنٹ گروپ لسٹ', '帐户组列表', 'Rekeninggroeplys', 'Kontengruppenliste', 'Λίστα ομάδων λογαριασμών', 'Lista de grupos de cuentas', 'खाता समूह सूची', 'Список групп счетов', 'Kontogruppeliste', 'Հաշվի խմբի ցուցակը', 'ანგარიშის ჯგუფის სია', 'खाते गट यादी', 'Senarai Kumpulan Akaun', 'ਖਾਤਾ ਸਮੂਹ ਸੂਚੀ', 'கணக்கு குழு பட்டியல்', 'ఖాతా సమూహ జాబితా', 'Kontogruppslista', 'Listahan ng Pangkat ng Account');
INSERT INTO `languages` VALUES (644, 'mailbox', 'Mailbox', 'ডাকবাক্স', 'صندوق بريد', 'Boites aux lettres', 'मेलबॉक्स', 'Kotak surat', 'Cassetta postale', 'メールボックス', '사서함', 'Mailbox', 'Caixa de correio', 'ตู้จดหมาย', 'Posta kutusu', 'میل باکس', '邮箱', 'posbus', 'Mailbox', 'Γραμματοκιβώτιο', 'Buzón', 'मेलबक्स', 'почтовый ящик', 'Postkasse', 'Փոստարկղ', 'საფოსტო ყუთი', 'मेलबॉक्स', 'Peti Mel', 'ਮੇਲਬਾਕਸ', 'அஞ்சல் பெட்டி', 'మెయిల్బాక్స్', 'Brevlåda', 'Mailbox');
INSERT INTO `languages` VALUES (645, 'refresh_mail', 'Refresh Mail', 'রিফ্রেশ মেল', 'تحديث البريد', 'Refresh Mail', 'मेल को रिफ्रेश करें', 'Segarkan Surat', 'Aggiorna posta', 'メールを更新', '메일 새로 고침', 'Mail vernieuwen', 'Refresh Mail', 'รีเฟรชเมล', 'Postayı Yenile', 'ریفریش میل', '刷新邮件', 'Verfris e-pos', 'Refresh Mail', 'Ανανέωση αλληλογραφίας', 'Actualizar correo', 'ताजा मेल', 'Обновить почту', 'Refresh Mail', 'Թարմացրեք փոստը', 'განაახლეთ ფოსტა', 'रीफ्रेश', 'Muat semula Mel', 'ਤਾਜ਼ਾ ਮੇਲ', 'அஞ்சலைப் புதுப்பிக்கவும்', 'మెయిల్ రిఫ్రెష్ చేయండి', 'Uppdatera e-post', 'I-refresh ang Mail');
INSERT INTO `languages` VALUES (646, 'sender', 'Sender', 'প্রেরকের', 'مرسل', 'expéditeur', 'प्रेषक', 'pengirim', 'mittente', '送信者', '보내는 사람', 'verzender', 'remetente', 'ผู้ส่ง', 'gönderen', 'مرسل', '寄件人', 'sender', 'Sender', 'αποστολέας', 'remitente', 'प्रेषक', 'отправитель', 'Sender', 'հեռագրական', 'Sender', 'प्रेषक', 'Pengguna', 'ਪ੍ਰੇਸ਼ਕ', 'அனுப்புநர்', 'పంపినవారు', 'Avsändare', 'nagpadala');
...
INSERT INTO `languages` VALUES (772, 'yes_continue', 'Yes, Continue', 'হ্যাঁ, চালিয়ে যান', 'نعم ، استمر', 'Oui, continuez', 'हां, जारी रखें', 'Ya, Lanjutkan', 'Sì, continua', 'はい、続行します', '예, 계속', 'Ja, doorgaan', 'Sim, continue', 'ใช่ดำเนินการต่อ', 'Evet devam et', 'ہاں ، جاری رکھیں', '是的，继续', 'Ja, gaan voort', 'Ja, weiter', 'Ναι, συνεχίστε', 'Sí, continuar', 'हो, जारी राख्नुहोस्', 'Да, продолжить', 'Ja, fortsæt', 'Այո, շարունակեք', 'დიახ, განაგრძეთ', 'होय, सुरू ठेवा', 'Ya, Teruskan', 'ਹਾਂ, ਜਾਰੀ ਰੱਖੋ', 'ஆம், தொடரவும்', 'అవును, కొనసాగించండి', 'Ja, fortsätt', 'Oo, Magpatuloy');
INSERT INTO `languages` VALUES (773, 'deleted', 'Deleted', 'মুছে ফেলা', 'تم الحذف', 'Effacé', 'हटाए गए', 'Dihapus', 'Deleted', '削除しました', '삭제', 'Verwijderd', 'Excluído', 'ลบ', 'silindi', 'حذف ہوگیا', '已删除', 'verwyderde', 'Gelöscht', 'Διαγράφηκε', 'Eliminado', 'मेटाइयो', 'Исключен', 'Slettet', 'Նջված է', 'ამოღებულია', 'हटविले', 'Dipadamkan', 'ਮਿਟਾਇਆ ਗਿਆ', 'நீக்கப்பட்டது', 'తొలగించిన', 'raderade', 'Tinanggal');
INSERT INTO `languages` VALUES (774, 'collect', 'Collect', 'সংগ্রহ', 'تجميع', 'Collecte', 'कलेक्ट', 'Mengumpulkan', 'Raccogliere', '集める', '수집', 'Verzamelen', 'Coletar', 'เก็บ', 'Toplamak', 'جمع کریں', '收集', 'Versamel', 'Sammeln', 'Συλλέγω', 'Recoger', 'स .्कलन गर्नुहोस्', 'Collect', 'Indsamle', 'Հավաքել', 'Შეგროვება', 'गोळा करा', 'Kumpulkan', 'ਇਕੱਠਾ ਕਰੋ', 'திரட்டுதல்', 'సేకరించండి', 'Samla', 'Kolektahin');
INSERT INTO `languages` VALUES (775, 'school_setting', 'School Setting', 'স্কুল সেটিং', 'إعداد المدرسة', 'Milieu scolaire', 'स्कूल की स्थापना', 'Pengaturan sekolah', 'Impostazione della scuola', '学校の設定', '학교 환경 설정', 'School instelling', 'Escola, armando', 'สภาพแวดล้อมของโรงเรียน', 'Okul ayarı', 'سکول کی ترتیب', '学校环境', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (776, 'set', 'Set', 'সেট', 'جلس', 'Ensemble', 'सेट', 'Set', 'Impostato', 'セットする', '세트', 'Stel', 'Conjunto', 'ชุด', 'Ayarlamak', 'سیٹ کریں', '组', 'stel', 'einstellen', 'Σειρά', 'Conjunto', 'सेट', 'Набор', 'Sæt', 'Սահմանել', 'მითითებული', 'सेट', 'Tetapkan', 'ਸੈੱਟ ਕਰੋ', 'அமை', 'సెట్', 'Uppsättning', 'Itakda');
INSERT INTO `languages` VALUES (777, 'quick_view', 'Quick View', 'তারাতারি দেখা', 'نظرة سريعة', 'Aperçu rapide', 'जल्दी देखो', 'Lihat sekilas', 'Occhiata veloce', 'クイックビュー', '퀵뷰', 'Snelle kijk', 'Olhada rápida', 'มุมมองด่วน', 'Hızlı Görünüm', 'فوری نظارہ', '快速浏览', 'Vinnige oorsig', 'Schnellansicht', 'Γρήγορη ματιά', 'Vista rápida', 'द्रुत दृश्य', 'Быстрый просмотр', 'Hurtigt kig', 'Արագ դիտում', 'სწრაფი ხედი', 'द्रुत दृश्य', 'Pandangan Pantas', 'ਤੇਜ਼ ਝਲਕ', 'விரைவான பார்வை', 'శీఘ్ర వీక్షణ', 'Snabbtitt', 'Mabilis na Tingnan');
INSERT INTO `languages` VALUES (778, 'due_fees_invoice', 'Due Fees Invoice', 'পারিশ্রমিক ফি চালান', 'فاتورة رسوم مستحقة', 'Facture due', 'देय शुल्क चालान', 'Tagihan Biaya karena', 'Fattura dovuta', '納付書', '회비 청구서', 'Factuur verschuldigd', '', 'ใบแจ้งหนี้ค่าธรรมเนียม', 'Ödenmesi Gereken Fatura', 'واجب الادا فیس انوائس', '应付费用发票', 'Faktuur vir verskuldigde gelde', 'Rechnung über fällige Gebühren', 'Τιμολόγιο οφειλόμενων χρεώσεων', 'Factura de cuotas adeudadas', 'शुल्क शुल्क चलानी', 'Счет-фактура', 'Forfaldsfaktura', 'Պարտքերի վճարման հաշիվ', 'საგადასახადო საფასურის ინვოისი', 'देय फी फी', 'Invois Yuran Hutang', 'ਬਕਾਇਆ ਫੀਸ ਇਨਵੌਇਸ', 'செலுத்த வேண்டிய கட்டணம் விலைப்பட்டியல்', 'చెల్లించాల్సిన ఫీజు ఇన్వాయిస్', 'Fakturor om förfallna avgifter', 'Dahil sa Bayad na Bayad');
INSERT INTO `languages` VALUES (779, 'my_application', 'My Application', 'আমার আবেদন', 'طلبي', 'Mon application', 'मेरा आवेदन', 'Lamaran saya', 'La mia applicazione', '私のアプリケーション', '내 응용 프로그램', 'Mijn aanvraag', '', 'ใบสมัครของฉัน', 'Başvurum', 'میری درخواست', '我的应用程序', 'My aansoek', 'Meine Bewerbung', 'Η αίτησή μου', 'Mi aplicación', 'मेरो अनुप्रयोग', 'Мое приложение', 'Min ansøgning', 'Իմ դիմումը', 'Ჩემი განაცხადი', 'माझा अर्ज', 'Permohonan saya', 'ਮੇਰੀ ਐਪਲੀਕੇਸ਼ਨ', 'எனது விண்ணப்பம்', 'నా దరఖాస్తు', 'Min ansökan', 'Aking Application');
INSERT INTO `languages` VALUES (780, 'manage_application', 'Manage Application', 'অ্যাপ্লিকেশন পরিচালনা করুন', 'إدارة الطلب', 'Gérer l\'application', 'एप्लिकेशन प्रबंधित करें', 'Kelola Aplikasi', 'Gestisci applicazione', 'アプリケーションを管理', '응용 프로그램 관리', 'Applicatie beheren', '', 'จัดการแอปพลิเคชัน', 'Uygulamayı yönet', 'درخواست کا انتظام کریں', '管理申请', 'Bestuur die toepassing', 'Anwendung verwalten', 'Διαχείριση εφαρμογής', 'Administrar aplicación', 'अनुप्रयोग प्रबन्ध गर्नुहोस्', 'Управление приложением', 'Administrer applikation', 'Կառավարեք դիմումը', 'პროგრამის მართვა', 'अनुप्रयोग व्यवस्थापित करा', 'Urus Permohonan', 'ਐਪਲੀਕੇਸ਼ਨ ਦਾ ਪ੍ਰਬੰਧਨ ਕਰੋ', 'பயன்பாட்டை நிர்வகிக்கவும்', 'అనువర్తనాన్ని నిర్వహించండి', 'Hantera applikation', 'Pamahalaan ang Application');
INSERT INTO `languages` VALUES (781, 'leave', 'Leave', 'ছুটি', 'غادر', 'Laisser', 'छोड़ना', 'Meninggalkan', 'Partire', '去る', '떠나다', 'Het verlof', '', 'ออกจาก', 'Ayrılmak', 'چھوڑ دو', '离开', 'Verlaat', 'Verlassen', 'Αδεια', 'Salir', 'छोड', 'Оставлять', 'Forlade', 'Հեռացեք', 'დატოვე', 'सोडा', 'Tinggalkan', 'ਛੱਡੋ', 'விடுங்கள்', 'లీవ్', 'Lämna', 'Umalis');
...
INSERT INTO `languages` VALUES (951, 'percentage', 'Percentage', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'persentasie', 'Prozentsatz', 'Ποσοστό', 'Porcentaje', 'प्रतिशत', 'процент', 'Procent', 'Տոկոս', 'პროცენტი', 'टक्केवारी', 'Peratusan', 'ਪ੍ਰਤੀਸ਼ਤ', 'சதவிதம்', 'శాతం', 'Procentsats', 'Porsyento');
INSERT INTO `languages` VALUES (952, 'value', 'Value', 'মান', 'القيمة', 'Valeur', 'मूल्य', 'Nilai', 'Valore', '値', '값', 'Waarde', 'Valor', 'ราคา', 'değer', 'قدر', '值', 'waarde', 'Wert', 'αξία', 'Valor', 'मान', 'Ценность', 'Værdi', 'Արժեք', 'ღირებულება', 'मूल्य', 'Nilai', 'ਮੁੱਲ', 'மதிப்பு', 'విలువ', 'Värde', 'Halaga');
INSERT INTO `languages` VALUES (953, 'fee_group', 'Fee Group', 'ফি গ্রুপ', 'مجموعة الرسوم', 'Groupe de frais', 'शुल्क समूह', 'Kelompok Biaya', 'Gruppo di commissioni', '料金グループ', '요금 그룹', 'Kostengroep', 'Grupo de taxas', 'กลุ่มค่าธรรมเนียม', 'Ücret Grubu', 'فیس گروپ', '费用组', 'Fooi-groep', 'Gebührengruppe', 'Ομάδα αμοιβών', 'Grupo de tarifas', 'शुल्क समूह', 'Комиссия группы', 'Gebyrgruppe', 'Վճարների խումբ', 'საფასურის ჯგუფი', 'फी गट', 'Kumpulan Yuran', 'ਫੀਸ ਸਮੂਹ', 'கட்டணக் குழு', 'ఫీజు గ్రూప్', 'Avgiftsgrupp', 'Grupo ng Bayad');
INSERT INTO `languages` VALUES (954, 'due_invoice', 'Due Invoice', 'ইনভয়েস', 'فاتورة مستحقة', 'Facture due', 'कारण चालान', 'Faktur jatuh tempo', 'Fattura dovuta', '未払いの請求書', '인보이스', 'Te betalen factuur', 'Fatura vencida', 'ใบแจ้งหนี้เนื่องจาก', 'Vadesi Gelen Fatura', 'انوائس کی وجہ سے', '到期发票', 'Behoorlike faktuur', 'Fällige Rechnung', 'Προθεσμιακό τιμολόγιο', 'Factura vencida', 'बाँकी इनभ्वाइस', 'Счет-фактура', 'Forfalden faktura', 'Ժամանակին հաշիվ-ապրանքագիր', 'ინვოისი', 'देय चलन', 'Invois Belum Selesai', 'ਬਕਾਇਆ ਚਲਾਨ', 'உரிய விலைப்பட்டியல்', 'డ్యూ ఇన్వాయిస్', 'Skyldig faktura', 'Dahil sa Invoice');
INSERT INTO `languages` VALUES (955, 'reminder', 'Reminder', 'অনুস্মারক', 'تذكير', 'Rappel', 'अनुस्मारक', 'Peringatan', 'Promemoria', 'リマインダー', '조언', 'Herinnering', 'Lembrete', 'การแจ้งเตือน', 'Hatırlatma', 'یاد دہانی', '提醒', 'herinnering', 'Erinnerung', 'Υπενθύμιση', 'Recordatorio', 'अनुस्मारक', 'напоминание', 'Påmindelse', 'Հիշեցում', 'შეხსენება', 'स्मरणपत्र', 'Peringatan', 'ਰੀਮਾਈਂਡਰ', 'நினைவூட்டல்', 'రిమైండర్', 'Påminnelse', 'Paalala');
INSERT INTO `languages` VALUES (956, 'frequency', 'Frequency', 'ফ্রিকোয়েন্সি', 'تكرر', 'La fréquence', 'आवृत्ति', 'Frekuensi', 'Frequenza', '周波数', '회수', 'Frequentie', 'Frequência', 'ความถี่', 'Sıklık', 'تعدد', '频率', 'Frekwensie', 'Frequenz', 'Συχνότητα', 'Frecuencia', 'फ्रिक्वेन्सी', 'частота', 'Frekvens', 'Հաճախականությունը', 'სიხშირე', 'वारंवारता', 'Kekerapan', 'ਬਾਰੰਬਾਰਤਾ', 'அதிர்வெண்', 'తరచుదనం', 'Frekvens', 'Dalas');
INSERT INTO `languages` VALUES (957, 'notify', 'Notify', 'অবহিত', 'أبلغ', 'Notifier', 'सूचित करें', 'Memberitahukan', 'Notificare', '通知する', '통지', 'Melden', 'Notificar', 'แจ้ง', 'bildirmek', 'مطلع', '通知', 'Stel', 'Benachrichtigen', 'Κοινοποιώ', 'Notificar', 'सूचित गर्नुहोस्', 'Уведомлять', 'Underrette', 'Տեղեկացնել', 'შეატყობინე', 'सूचित करा', 'Maklumkan', 'ਨੂੰ ਸੂਚਿਤ ਕਰੋ', 'அறிவிக்கவும்', 'తెలియజేయి', 'Meddela', 'Ipaalam');
INSERT INTO `languages` VALUES (958, 'before', 'Before', 'আগে', 'قبل', 'Avant', 'इससे पहले', 'Sebelum', 'Prima', '前', '전에', 'Voordat', 'Antes', 'ก่อน', 'Önce', 'پہلے', '之前', 'voordat', 'Vor', 'Πριν', 'antes de', 'पहिले', 'Перед', 'Før', 'Նախքան', 'ადრე', 'आधी', 'Sebelum', 'ਪਹਿਲਾਂ', 'முன்', 'ముందు', 'Innan', 'Bago');
INSERT INTO `languages` VALUES (959, 'after', 'After', 'পরে', 'بعد', 'Après', 'उपरांत', 'Setelah', 'Dopo', '後', '후', 'Na', 'Depois de', 'หลังจาก', 'Sonra', 'کے بعد', '后', 'na', 'Nach', 'Μετά', 'Después', 'पछि', 'После', 'Efter', 'Հետո', 'მას შემდეგ', 'नंतर', 'Selepas', 'ਦੇ ਬਾਅਦ', 'பிறகு', 'తరువాత', 'Efter', 'Pagkatapos');
INSERT INTO `languages` VALUES (960, 'number', 'Number', 'সংখ্যা', 'رقم', 'Nombre', 'संख्या', 'Jumlah', 'Numero', '数', '번호', 'Aantal', 'Número', 'จำนวน', 'Numara', 'نمبر', '数', 'aantal', 'Nummer', 'Αριθμός', 'Número', 'संख्या', 'Число', 'Nummer', 'Թիվ', 'რიცხვი', 'संख्या', 'Nombor', 'ਗਿਣਤੀ', 'எண்', 'సంఖ్య', 'siffra', 'Bilang');
INSERT INTO `languages` VALUES (961, 'ref_no', 'Ref No', 'সুত্র নেই', 'مصدر رقم', 'Réf No', 'संदर्भ संख्या', 'Nomor referensi', 'Ref no', '参照番号', '참조 번호', 'Ref nr', 'Nº de referência', 'เลขที่อ้างอิง', 'Ref No', 'ریف نمبر', '参考编号', 'Verw No', 'Referenznummer', 'Αναφορά αριθ', 'Número de referencia', 'रेफ्रे नम्बर', 'Ref №', 'Ref nr', 'Ref ոչ', 'Ref არა', 'संदर्भ क्रमांक', 'Nombor rujukan', 'ਹਵਾਲਾ ਨੰ', 'Ref எண்', 'సూచిక క్రమాంకము', 'Ref nr', 'Ref Hindi');
INSERT INTO `languages` VALUES (962, 'pay_via', 'Pay Via', 'ভায়া দিয়ে', 'ادفع عن طريق', 'Payez via', 'भुगतान करें', 'Bayar Via', 'Pay Via', '経由で支払う', '통해 지불', 'Pay Via', 'Pay Via', 'ชำระเงินผ่าน', 'Ödeme Yöntemi', 'ویا کے ذریعہ', '通过付款', 'Betaal via', 'Zahlen Sie über', 'Πληρώστε μέσω', 'Pagar vía', 'भुक्तान मार्फत', 'Оплатить через', 'Betal via', 'Վճարիր միջոցով', 'გადაიხადე ვია', 'पे मार्गे', 'Bayar Melalui', 'ਭੁਗਤਾਨ ਦੁਆਰਾ', 'வழியாக செலுத்தவும்', 'ద్వారా చెల్లించండి', 'Betala via', 'Magbayad Via');
INSERT INTO `languages` VALUES (963, 'ref', 'Ref', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (964, 'dr', 'Dr', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (965, 'cr', 'Cr', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `languages` VALUES (966, 'edit_book', 'Edit Book', 'সম্পাদনা বই', 'تحرير كتاب', 'Modifier le livre', 'पुस्तक संपादित करें', 'Edit Buku', 'Modifica libro', '本を編集', '책 편집', 'Boek bewerken', 'Editar livro', 'แก้ไขหนังสือ', 'Kitabı Düzenle', 'کتاب میں ترمیم کریں', '编辑书', 'Redigeer boek', 'Buch bearbeiten', 'Επεξεργασία βιβλίου', 'Editar libro', 'पुस्तक सम्पादन गर्नुहोस्', 'Редактировать книгу', 'Rediger bog', 'Խմբագրել գիրքը', 'წიგნის რედაქტირება', 'पुस्तक संपादित करा', 'Edit Buku', 'ਕਿਤਾਬ ਸੋਧੋ', 'புத்தகத்தைத் திருத்து', 'పుస్తకాన్ని సవరించండి', 'Redigera bok', 'I-edit ang Aklat');
INSERT INTO `languages` VALUES (967, 'leaves', 'Leaves', 'পত্রাদি', 'اوراق اشجار', 'Feuilles', 'पत्ते', 'Daun-daun', 'Le foglie', '葉', '이파리', 'Bladeren', 'Folhas', 'ใบไม้', 'Yapraklar', 'پتے', '树叶', 'blare', 'Blätter', 'Φύλλα', 'Hojas', 'पातहरू', 'Листья', 'Blade', 'Թողնում է', 'ტოვებს', 'पाने', 'Daun', 'ਪੱਤੇ', 'இலைகள்', 'ఆకులు', 'Löv', 'Mga dahon');
INSERT INTO `languages` VALUES (968, 'leave_request', 'Leave Request', 'অনুরোধ ত্যাগ করুন', 'طلب إجازة', 'Demande de congé', 'छुट्टी का अनुरोध', 'Tinggalkan Permintaan', 'Lascia una richiesta', '休暇願', '요청을 남겨주세요', 'Verzoek indienen', 'Deixar pedido', 'ใบลา', 'Ayrılma İsteği', 'درخواست چھوڑ دیں', '休假申请', 'Verlaat versoek', 'Anfrage hinterlassen', 'Αίτημα αποχώρησης', 'Dejar petición', 'अनुरोध छोड्नुहोस्', 'Оставьте запрос', 'Forlad anmodning', 'Թողեք հայցը', 'დატოვე მოთხოვნა', 'विनंती सोडा', 'Tinggalkan Permintaan', 'ਬੇਨਤੀ ਛੱਡੋ', 'கோரிக்கை விடுங்கள்', 'అభ్యర్థనను వదిలివేయండి', 'Lämna förfrågan', 'Mag-iwan ng Kahilingan');
